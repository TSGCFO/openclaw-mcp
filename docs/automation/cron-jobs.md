...
title: "Scheduled tasks - OpenClaw"
---
...
- [Day-of-month and day-of-week use OR logic](https://docs.openclaw.ai/automation/cron-jobs#day-of-month-and-day-of-week-use-or-logic)
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#quick-start)  Quick start
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#how-cron-works)  How cron works
...
- All cron executions create [background task](https://docs.openclaw.ai/automation/tasks) records.
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#schedule-types)  Schedule types
...
### [​](https://docs.openclaw.ai/automation/cron-jobs\#day-of-month-and-day-of-week-use-or-logic)  Day-of-month and day-of-week use OR logic
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#execution-styles)  Execution styles
...
### [​](https://docs.openclaw.ai/automation/cron-jobs\#payload-options-for-isolated-jobs)  Payload options for isolated jobs
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#delivery-and-output)  Delivery and output
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#cli-examples)  CLI examples
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#webhooks)  Webhooks
...
### [​](https://docs.openclaw.ai/automation/cron-jobs\#authentication)  Authentication
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#gmail-pubsub-integration)  Gmail PubSub integration
...
### [​](https://docs.openclaw.ai/automation/cron-jobs\#wizard-setup-recommended)  Wizard setup (recommended)
...
### [​](https://docs.openclaw.ai/automation/cron-jobs\#gateway-auto-start)  Gateway auto-start
...
### [​](https://docs.openclaw.ai/automation/cron-jobs\#manual-one-time-setup)  Manual one-time setup
...
### [​](https://docs.openclaw.ai/automation/cron-jobs\#gmail-model-override)  Gmail model override
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#managing-jobs)  Managing jobs
...
### [​](https://docs.openclaw.ai/automation/cron-jobs\#command-ladder)  Command ladder
...
## [​](https://docs.openclaw.ai/automation/cron-jobs\#related)  Related
