...
- [command-logger details](https://docs.openclaw.ai/automation/hooks#command-logger-details)
- [boot-md details](https://docs.openclaw.ai/automation/hooks#boot-md-details)
...
## [​](https://docs.openclaw.ai/automation/hooks\#quick-start)  Quick start
...
## [​](https://docs.openclaw.ai/automation/hooks\#writing-hooks)  Writing hooks
...
### [​](https://docs.openclaw.ai/automation/hooks\#event-context-highlights)  Event context highlights
...
### [​](https://docs.openclaw.ai/automation/hooks\#hook-packs)  Hook packs
...
### [​](https://docs.openclaw.ai/automation/hooks\#session-memory-details)  session-memory details
...
### [​](https://docs.openclaw.ai/automation/hooks\#bootstrap-extra-files-config)  bootstrap-extra-files config
...
### [​](https://docs.openclaw.ai/automation/hooks\#command-logger-details)  command-logger details

Logs every slash command to `~/.openclaw/logs/commands.log`.

### [​](https://docs.openclaw.ai/automation/hooks\#boot-md-details)  boot-md details

Runs `BOOT.md` from the active workspace when the gateway starts.

## [​](https://docs.openclaw.ai/automation/hooks\#plugin-hooks)  Plugin hooks
...
## [​](https://docs.openclaw.ai/automation/hooks\#cli-reference)  CLI reference
...
## [​](https://docs.openclaw.ai/automation/hooks\#related)  Related
