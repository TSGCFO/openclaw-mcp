...
- [Outbound target prefixes](https://docs.openclaw.ai/channels/channel-routing#outbound-target-prefixes)
...
- [Guarded inbound recording](https://docs.openclaw.ai/channels/channel-routing#guarded-inbound-recording)
...
## [​](https://docs.openclaw.ai/channels/channel-routing\#outbound-target-prefixes)  Outbound target prefixes
...
## [​](https://docs.openclaw.ai/channels/channel-routing\#guarded-inbound-recording)  Guarded inbound recording
