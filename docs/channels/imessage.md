...
- [Related](https://docs.openclaw.ai/channels/imessage#related)
...
\\
Preferred iMessage path for new setups.](https://docs.openclaw.ai/channels/bluebubbles)

[**Pairing** \\
\\
iMessage DMs default to pairing mode.](https://docs.openclaw.ai/channels/pairing)

[**Configuration reference** \\
\\
Full iMessage field reference.](https://docs.openclaw.ai/gateway/config-channels#imessage)
...
## [​](https://docs.openclaw.ai/channels/imessage\#acp-conversation-bindings)  ACP conversation bindings
...
- [Configuration reference - iMessage](https://docs.openclaw.ai/gateway/config-channels#imessage)
- [Gateway configuration](https://docs.openclaw.ai/gateway/configuration)
- [Pairing](https://docs.openclaw.ai/channels/pairing)
- [BlueBubbles](https://docs.openclaw.ai/channels/bluebubbles)

## [​](https://docs.openclaw.ai/channels/imessage\#related)  Related
...
[Google Chat](https://docs.openclaw.ai/channels/googlechat) [BlueBubbles](https://docs.openclaw.ai/channels/bluebubbles)
