...
- [Socket Mode transport tuning](https://docs.openclaw.ai/channels/slack#socket-mode-transport-tuning)
- [Manifest and scope checklist](https://docs.openclaw.ai/channels/slack#manifest-and-scope-checklist)
- [Additional manifest settings](https://docs.openclaw.ai/channels/slack#additional-manifest-settings)
...
- [Typing reaction fallback](https://docs.openclaw.ai/channels/slack#typing-reaction-fallback)
...
- [Interactive replies](https://docs.openclaw.ai/channels/slack#interactive-replies)
- [Exec approvals in Slack](https://docs.openclaw.ai/channels/slack#exec-approvals-in-slack)
- [Events and operational behavior](https://docs.openclaw.ai/channels/slack#events-and-operational-behavior)
- [Configuration reference](https://docs.openclaw.ai/channels/slack#configuration-reference)
- [Troubleshooting](https://docs.openclaw.ai/channels/slack#troubleshooting)
- [Attachment vision reference](https://docs.openclaw.ai/channels/slack#attachment-vision-reference)
- [Supported media types](https://docs.openclaw.ai/channels/slack#supported-media-types)
- [Inbound pipeline](https://docs.openclaw.ai/channels/slack#inbound-pipeline)
- [Thread-root attachment inheritance](https://docs.openclaw.ai/channels/slack#thread-root-attachment-inheritance)
- [Multi-attachment handling](https://docs.openclaw.ai/channels/slack#multi-attachment-handling)
- [Size, download, and model limits](https://docs.openclaw.ai/channels/slack#size-download-and-model-limits)
- [Known limits](https://docs.openclaw.ai/channels/slack#known-limits)
- [Related documentation](https://docs.openclaw.ai/channels/slack#related-documentation)
...
## [​](https://docs.openclaw.ai/channels/slack\#socket-mode-transport-tuning)  Socket Mode transport tuning
...
### [​](https://docs.openclaw.ai/channels/slack\#additional-manifest-settings)  Additional manifest settings
...
Multiple [native slash commands](https://docs.openclaw.ai/channels/slack#commands-and-slash-behavior) can be used instead of a single configured command with nuance:
...
Replace your existing `features.slash_commands` section with a subset of [available commands](https://docs.openclaw.ai/tools/slash-commands#command-list):
...
## [​](https://docs.openclaw.ai/channels/slack\#typing-reaction-fallback)  Typing reaction fallback
...
Native commands require [additional manifest settings](https://docs.openclaw.ai/channels/slack#additional-manifest-settings) in your Slack app and are enabled with `channels.slack.commands.native: true` or `commands.native: true` in global configurations instead.
...
## [​](https://docs.openclaw.ai/channels/slack\#interactive-replies)  Interactive replies
...
## [​](https://docs.openclaw.ai/channels/slack\#exec-approvals-in-slack)  Exec approvals in Slack
...
approvals are unavailable or manual approval is the only path.Config path:
...
Set `enabled: true` to force native approvals on when approvers resolve.Default behavior with no explicit Slack exec approval config:
...
in Slack.Same-chat `/approve` also works in Slack channels and DMs that already support commands. See [Exec approvals](https://docs.openclaw.ai/tools/exec-approvals) for the full approval forwarding model.
...
## [​](https://docs.openclaw.ai/channels/slack\#configuration-reference)  Configuration reference

Primary reference: [Configuration reference - Slack](https://docs.openclaw.ai/gateway/config-channels#slack).
...
Validate bot + app tokens and Socket Mode enablement in Slack app settings.If `openclaw channels status --probe --json` shows `botTokenStatus` or
...
## [​](https://docs.openclaw.ai/channels/slack\#attachment-vision-reference)  Attachment vision reference
...
### [​](https://docs.openclaw.ai/channels/slack\#supported-media-types)  Supported media types
...
### [​](https://docs.openclaw.ai/channels/slack\#inbound-pipeline)  Inbound pipeline
...
### [​](https://docs.openclaw.ai/channels/slack\#thread-root-attachment-inheritance)  Thread-root attachment inheritance
...
### [​](https://docs.openclaw.ai/channels/slack\#multi-attachment-handling)  Multi-attachment handling
...
### [​](https://docs.openclaw.ai/channels/slack\#size-download-and-model-limits)  Size, download, and model limits
...
### [​](https://docs.openclaw.ai/channels/slack\#known-limits)  Known limits
...
### [​](https://docs.openclaw.ai/channels/slack\#related-documentation)  Related documentation

- [Media understanding pipeline](https://docs.openclaw.ai/nodes/media-understanding)
...
[**Pairing** \\
\\
Pair a Slack user to the gateway.](https://docs.openclaw.ai/channels/pairing)

[**Groups** \\
\\
Channel and group DM behavior.](https://docs.openclaw.ai/channels/groups)
...
[**Configuration** \\
\\
Config layout and precedence.](https://docs.openclaw.ai/gateway/configuration)

[**Slash commands** \\
\\
Command catalog and behavior.](https://docs.openclaw.ai/tools/slash-commands)

[Discord](https://docs.openclaw.ai/channels/discord) [Telegram](https://docs.openclaw.ai/channels/telegram)
