---
source_url: https://docs.openclaw.ai/channels/slack.md
title: ""
---
...
\`\`\`json theme={"theme":{"light":"min-light","dark":"min-dark"}}
{
 ...
 "features": {
 "bot\_user": { "display\_name": "OpenClaw", "always\_online": true },
 "app\_home": {
 "home\_tab\_enabled": true,
...
\`\`\`json theme={"theme":{"light":"min-light","dark":"min-dark"}}
{
 ...
 "settings": {
 "event\_subscriptions": {
 "request\_url": "https://gateway-host.example.com/slack/events",
 "bot\_events": \[\
 /\\* same as Socket Mode \*/\
 \]
 },
 ...
 "is\_enabled": true,
 "request\_url": "https://gateway-host.example.com/slack/events",
 "message\_menu\_options\_url": "https://gateway-host.example.com/slack/events"
 }
 }
}
\`\`\`
...
The default manifest enables the Slack App Home \*\*Home\*\* tab and subscribes to \`app\_home\_opened\`. When a workspace member opens the Home tab, OpenClaw publishes a safe default Home view with \`views.publish\`; no conversation payload or private configuration is included. The \*\*Messages\*\* tab remains enabled for Slack DMs.
 ...
 Replace your existing \`features.slash\_commands\` section with a subset of \[available commands\](/tools/slash-commands#command-list):
 ...
 "usage\_hint": "on\|off\|full"\
 },\
 {\
 "command": "/fast",\
 "description": "Show or set fast mode",\
 "usage\_hint": "\[status\|on\|off\]"\
 },\
 {\
 "command": "/reasoning",\
 "description": "Toggle reasoning visibility",\
 "usage\_hint": "\[on\|off\|stream\]"\
 },\
 {\
 "command": "/elevated",\
 "description": "Toggle elevated mode",\
 "usage\_hint": "\[on\|off\|ask\|full\]"\
 },\
 {\
 "command": "/exec",\
 "description": "Show or set exec defaults",\
 "usage\_hint": "host= security= ask= node="\
 },\
 {\
 "command": "/model",\
 "description": "Show or set the model",\
 "usage\_hint": "\[name\|#\|status\]"\
 },\
 {\
 "command": "/models",\
 "description": "List providers/models",\
 "usage\_hint": "\[provider\] \[page\] \[limit=\|size=\|all\]"\
 },\
 {\
 "command": "/help",\
 ...
 "usage\_hint": "off\|tokens\|full\|cost"\
 }\
 \]
 \`\`\`

 Use the same \`slash\_commands\` list as Socket Mode above, and add \`"url": "https://gateway-host.example.com/slack/events"\` to every entry. Example:
 ...
 If you use an emoji icon, Slack expects \`:emoji\_name:\` syntax.
...
\\* Status is \`available\`, \`configured\_unavailable\`, or \`missing\`.
\\* \`configured\_unavailable\` means the account is configured through SecretRef
...
Slash sessions use isolated keys like `agent::slack:slash:` and still route command executions to the target conversation session using `CommandTargetSessionKey`.
