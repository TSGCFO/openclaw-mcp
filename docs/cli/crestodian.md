...
[Skip to main content](https://docs.openclaw.ai/cli/crestodian#content-area)
...
- [openclaw crestodian](https://docs.openclaw.ai/cli/crestodian#openclaw-crestodian)
- [What Crestodian shows](https://docs.openclaw.ai/cli/crestodian#what-crestodian-shows)
- [Examples](https://docs.openclaw.ai/cli/crestodian#examples)
- [Safe startup](https://docs.openclaw.ai/cli/crestodian#safe-startup)
- [Operations and approval](https://docs.openclaw.ai/cli/crestodian#operations-and-approval)
- [Setup bootstrap](https://docs.openclaw.ai/cli/crestodian#setup-bootstrap)
- [Model-Assisted Planner](https://docs.openclaw.ai/cli/crestodian#model-assisted-planner)
- [Switching to an agent](https://docs.openclaw.ai/cli/crestodian#switching-to-an-agent)
- [Message rescue mode](https://docs.openclaw.ai/cli/crestodian#message-rescue-mode)
- [Related](https://docs.openclaw.ai/cli/crestodian#related)
...
# [​](https://docs.openclaw.ai/cli/crestodian\#openclaw-crestodian)  `openclaw crestodian`
...
## [​](https://docs.openclaw.ai/cli/crestodian\#what-crestodian-shows)  What Crestodian shows
...
## [​](https://docs.openclaw.ai/cli/crestodian\#examples)  Examples
...
## [​](https://docs.openclaw.ai/cli/crestodian\#safe-startup)  Safe startup
...
## [​](https://docs.openclaw.ai/cli/crestodian\#operations-and-approval)  Operations and approval
...
## [​](https://docs.openclaw.ai/cli/crestodian\#setup-bootstrap)  Setup bootstrap
...
## [​](https://docs.openclaw.ai/cli/crestodian\#model-assisted-planner)  Model-Assisted Planner
...
## [​](https://docs.openclaw.ai/cli/crestodian\#switching-to-an-agent)  Switching to an agent
...
## [​](https://docs.openclaw.ai/cli/crestodian\#message-rescue-mode)  Message rescue mode
...
## [​](https://docs.openclaw.ai/cli/crestodian\#related)  Related
