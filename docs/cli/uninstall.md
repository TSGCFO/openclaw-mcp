...
- [Related](https://docs.openclaw.ai/cli/uninstall#related)
...
# [​](https://docs.openclaw.ai/cli/uninstall\#openclaw-uninstall)  `openclaw uninstall`
...
## [​](https://docs.openclaw.ai/cli/uninstall\#related)  Related
