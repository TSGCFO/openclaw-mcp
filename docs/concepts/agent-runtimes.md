...
title: "Agent runtimes - OpenClaw"
---

[Skip to main content](https://docs.openclaw.ai/concepts/agent-runtimes#content-area)
...
- [Codex surfaces](https://docs.openclaw.ai/concepts/agent-runtimes#codex-surfaces)
- [Runtime ownership](https://docs.openclaw.ai/concepts/agent-runtimes#runtime-ownership)
- [Runtime selection](https://docs.openclaw.ai/concepts/agent-runtimes#runtime-selection)
- [Compatibility contract](https://docs.openclaw.ai/concepts/agent-runtimes#compatibility-contract)
- [Status labels](https://docs.openclaw.ai/concepts/agent-runtimes#status-labels)
- [Related](https://docs.openclaw.ai/concepts/agent-runtimes#related)
...
## [​](https://docs.openclaw.ai/concepts/agent-runtimes\#codex-surfaces)  Codex surfaces
...
## [​](https://docs.openclaw.ai/concepts/agent-runtimes\#runtime-ownership)  Runtime ownership
...
## [​](https://docs.openclaw.ai/concepts/agent-runtimes\#runtime-selection)  Runtime selection
...
## [​](https://docs.openclaw.ai/concepts/agent-runtimes\#compatibility-contract)  Compatibility contract
...
## [​](https://docs.openclaw.ai/concepts/agent-runtimes\#status-labels)  Status labels
...
## [​](https://docs.openclaw.ai/concepts/agent-runtimes\#related)  Related
