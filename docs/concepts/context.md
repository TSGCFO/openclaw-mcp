...
- [Skills: injected vs loaded on-demand](https://docs.openclaw.ai/concepts/context#skills-injected-vs-loaded-on-demand)
- [Tools: there are two costs](https://docs.openclaw.ai/concepts/context#tools-there-are-two-costs)
- [Commands, directives, and “inline shortcuts”](https://docs.openclaw.ai/concepts/context#commands-directives-and-%E2%80%9Cinline-shortcuts%E2%80%9D)
- [Sessions, compaction, and pruning (what persists)](https://docs.openclaw.ai/concepts/context#sessions-compaction-and-pruning-what-persists)
- [What /context actually reports](https://docs.openclaw.ai/concepts/context#what-%2Fcontext-actually-reports)
- [Related](https://docs.openclaw.ai/concepts/context#related)
...
## [​](https://docs.openclaw.ai/concepts/context\#skills-injected-vs-loaded-on-demand)  Skills: injected vs loaded on-demand
...
## [​](https://docs.openclaw.ai/concepts/context\#related)  Related
