...
- [Channel run ownership](https://docs.openclaw.ai/concepts/messages#channel-run-ownership)
...
## [​](https://docs.openclaw.ai/concepts/messages\#channel-run-ownership)  Channel run ownership
