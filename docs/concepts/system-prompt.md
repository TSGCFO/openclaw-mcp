...
- [Prompt snapshots](https://docs.openclaw.ai/concepts/system-prompt#prompt-snapshots)
...
## [​](https://docs.openclaw.ai/concepts/system-prompt\#prompt-snapshots)  Prompt snapshots
