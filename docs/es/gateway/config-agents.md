...
title: "Configuraci\u00f3n \u2014 agentes - OpenClaw"
---

[Saltar al contenido principal](https://docs.openclaw.ai/es/gateway/config-agents#content-area)
...
- [Valores predeterminados de agente](https://docs.openclaw.ai/es/gateway/config-agents#valores-predeterminados-de-agente)
- [agents.defaults.workspace](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-workspace)
- [agents.defaults.repoRoot](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-reporoot)
- [agents.defaults.skills](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-skills)
- [agents.defaults.skipBootstrap](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-skipbootstrap)
- [agents.defaults.skipOptionalBootstrapFiles](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-skipoptionalbootstrapfiles)
- [agents.defaults.contextInjection](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-contextinjection)
- [agents.defaults.bootstrapMaxChars](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-bootstrapmaxchars)
- [agents.defaults.bootstrapTotalMaxChars](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-bootstraptotalmaxchars)
- [agents.defaults.bootstrapPromptTruncationWarning](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-bootstrapprompttruncationwarning)
- [Mapa de propiedad del presupuesto de contexto](https://docs.openclaw.ai/es/gateway/config-agents#mapa-de-propiedad-del-presupuesto-de-contexto)
- [agents.defaults.startupContext](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-startupcontext)
- [agents.defaults.contextLimits](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-contextlimits)
- [agents.list\[\].contextLimits](https://docs.openclaw.ai/es/gateway/config-agents#agents-list-contextlimits)
- [skills.limits.maxSkillsPromptChars](https://docs.openclaw.ai/es/gateway/config-agents#skills-limits-maxskillspromptchars)
- [agents.list\[\].skillsLimits.maxSkillsPromptChars](https://docs.openclaw.ai/es/gateway/config-agents#agents-list-skillslimits-maxskillspromptchars)
- [agents.defaults.imageMaxDimensionPx](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-imagemaxdimensionpx)
- [agents.defaults.userTimezone](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-usertimezone)
- [agents.defaults.timeFormat](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-timeformat)
- [agents.defaults.model](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-model)
- [agents.defaults.agentRuntime](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-agentruntime)
- [agents.defaults.cliBackends](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-clibackends)
- [agents.defaults.systemPromptOverride](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-systempromptoverride)
- [agents.defaults.promptOverlays](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-promptoverlays)
- [agents.defaults.heartbeat](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-heartbeat)
- [agents.defaults.compaction](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-compaction)
- [agents.defaults.contextPruning](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-contextpruning)
- [Transmisión de bloques](https://docs.openclaw.ai/es/gateway/config-agents#transmisi%C3%B3n-de-bloques)
- [Indicadores de escritura](https://docs.openclaw.ai/es/gateway/config-agents#indicadores-de-escritura)
- [agents.defaults.sandbox](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-sandbox)
- [agents.list (sobrescrituras por agente)](https://docs.openclaw.ai/es/gateway/config-agents#agents-list-sobrescrituras-por-agente)
- [Enrutamiento multiagente](https://docs.openclaw.ai/es/gateway/config-agents#enrutamiento-multiagente)
- [Campos de coincidencia de vinculación](https://docs.openclaw.ai/es/gateway/config-agents#campos-de-coincidencia-de-vinculaci%C3%B3n)
- [Perfiles de acceso por agente](https://docs.openclaw.ai/es/gateway/config-agents#perfiles-de-acceso-por-agente)
- [Sesión](https://docs.openclaw.ai/es/gateway/config-agents#sesi%C3%B3n)
- [Mensajes](https://docs.openclaw.ai/es/gateway/config-agents#mensajes)
- [Prefijo de respuesta](https://docs.openclaw.ai/es/gateway/config-agents#prefijo-de-respuesta)
- [Reacción de acuse](https://docs.openclaw.ai/es/gateway/config-agents#reacci%C3%B3n-de-acuse)
- [Debounce de entrada](https://docs.openclaw.ai/es/gateway/config-agents#debounce-de-entrada)
- [TTS (texto a voz)](https://docs.openclaw.ai/es/gateway/config-agents#tts-texto-a-voz)
- [Talk](https://docs.openclaw.ai/es/gateway/config-agents#talk)
- [Relacionado](https://docs.openclaw.ai/es/gateway/config-agents#relacionado)
...
claves de nivel superior, consulta la [Referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference).

## [​](https://docs.openclaw.ai/es/gateway/config-agents\#valores-predeterminados-de-agente)  Valores predeterminados de agente

### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-workspace)  `agents.defaults.workspace`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-reporoot)  `agents.defaults.repoRoot`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-skills)  `agents.defaults.skills`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-skipbootstrap)  `agents.defaults.skipBootstrap`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-skipoptionalbootstrapfiles)  `agents.defaults.skipOptionalBootstrapFiles`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-contextinjection)  `agents.defaults.contextInjection`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-bootstrapmaxchars)  `agents.defaults.bootstrapMaxChars`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-bootstraptotalmaxchars)  `agents.defaults.bootstrapTotalMaxChars`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-bootstrapprompttruncationwarning)  `agents.defaults.bootstrapPromptTruncationWarning`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#mapa-de-propiedad-del-presupuesto-de-contexto)  Mapa de propiedad del presupuesto de contexto
...
#### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-startupcontext)  `agents.defaults.startupContext`
...
#### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-contextlimits)  `agents.defaults.contextLimits`
...
#### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-list-contextlimits)  `agents.list[].contextLimits`
...
#### [​](https://docs.openclaw.ai/es/gateway/config-agents\#skills-limits-maxskillspromptchars)  `skills.limits.maxSkillsPromptChars`
...
#### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-list-skillslimits-maxskillspromptchars)  `agents.list[].skillsLimits.maxSkillsPromptChars`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-imagemaxdimensionpx)  `agents.defaults.imageMaxDimensionPx`
...
Predeterminado: `1200`.Los valores más bajos suelen reducir el uso de tokens de visión y el tamaño de la carga de solicitud en ejecuciones con muchas capturas de pantalla.
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-usertimezone)  `agents.defaults.userTimezone`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-timeformat)  `agents.defaults.timeFormat`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-model)  `agents.defaults.model`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-agentruntime)  `agents.defaults.agentRuntime`
...
mental, consulta [tiempos de ejecución de agentes](https://docs.openclaw.ai/es/concepts/agent-runtimes).
...
Tus alias configurados siempre tienen prioridad sobre los valores predeterminados.Los modelos Z.AI GLM-4.x activan automáticamente el modo de razonamiento salvo que establezcas `--thinking off` o definas tú mismo `agents.defaults.models["zai/<model>"].params.thinking`.
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-clibackends)  `agents.defaults.cliBackends`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-systempromptoverride)  `agents.defaults.systemPromptOverride`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-promptoverlays)  `agents.defaults.promptOverlays`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-heartbeat)  `agents.defaults.heartbeat`
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-compaction)  `agents.defaults.compaction`
...
- `mode`: `default` o `safeguard` (resumen por fragmentos para historiales largos). Consulta [Compaction](https://docs.openclaw.ai/es/concepts/compaction).
- `provider`: id de un Plugin proveedor de Compaction registrado. Cuando está establecido, se llama a `summarize()` del proveedor en lugar del resumen LLM integrado. Recurre al integrado si falla. Establecer un proveedor fuerza `mode: "safeguard"`. Consulta [Compaction](https://docs.openclaw.ai/es/concepts/compaction).
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-contextpruning)  `agents.defaults.contextPruning`
...
**Recorte suave** conserva el principio y el final e inserta `...` en el medio.**Borrado completo** reemplaza todo el resultado de herramienta por el marcador de posición.Notas:
...
Consulta [Poda de sesión](https://docs.openclaw.ai/es/concepts/session-pruning) para detalles de comportamiento.

### [​](https://docs.openclaw.ai/es/gateway/config-agents\#transmisi%C3%B3n-de-bloques)  Transmisión de bloques
...
Consulta [Transmisión](https://docs.openclaw.ai/es/concepts/streaming) para obtener detalles sobre el comportamiento y la fragmentación.

### [​](https://docs.openclaw.ai/es/gateway/config-agents\#indicadores-de-escritura)  Indicadores de escritura
...
Consulta [Indicadores de escritura](https://docs.openclaw.ai/es/concepts/typing-indicators).

### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-defaults-sandbox)  `agents.defaults.sandbox`

Aislamiento opcional para el agente integrado. Consulta [Aislamiento](https://docs.openclaw.ai/es/gateway/sandboxing) para ver la guía completa.
...
`plugins.entries.openshell.config`.**Configuración del backend SSH:**
...
El transporte es SSH hacia el aislamiento de OpenShell, pero el Plugin controla el ciclo de vida del aislamiento y la sincronización espejo opcional.**`setupCommand`** se ejecuta una vez después de la creación del contenedor (mediante `sh -lc`). Necesita salida de red, raíz escribible y usuario root.**Los contenedores tienen `network: "none"` de forma predeterminada**; configúralo en `"bridge"` (o en una red bridge personalizada) si el agente necesita acceso saliente.
`"host"` está bloqueado. `"container:<id>"` está bloqueado de forma predeterminada salvo que configures explícitamente
`sandbox.docker.dangerouslyAllowContainerNamespaceJoin: true` (ruptura de emergencia).**Los adjuntos entrantes** se preparan en `media/inbound/*` en el espacio de trabajo activo.**`docker.binds`** monta directorios adicionales del host; los montajes globales y por agente se combinan.**Navegador aislado** (`sandbox.browser.enabled`): Chromium + CDP en un contenedor. URL de noVNC inyectada en el prompt del sistema. No requiere `browser.enabled` en `openclaw.json`.
...
El aislamiento del navegador y `sandbox.docker.binds` son exclusivos de Docker.Construir imágenes (desde un checkout del código fuente):
...
Para instalaciones npm sin un checkout del código fuente, consulta [Aislamiento § Imágenes y configuración](https://docs.openclaw.ai/es/gateway/sandboxing#images-and-setup) para ver comandos `docker build` en línea.

### [​](https://docs.openclaw.ai/es/gateway/config-agents\#agents-list-sobrescrituras-por-agente)  `agents.list` (sobrescrituras por agente)
...
la herramienta de agente `tts`. Consulta [Texto a voz](https://docs.openclaw.ai/es/tools/tts#per-agent-voice-overrides)
...
## [​](https://docs.openclaw.ai/es/gateway/config-agents\#enrutamiento-multiagente)  Enrutamiento multiagente

Ejecuta varios agentes aislados dentro de un Gateway. Consulta [Multiagente](https://docs.openclaw.ai/es/concepts/multi-agent).
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#campos-de-coincidencia-de-vinculaci%C3%B3n)  Campos de coincidencia de vinculación
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#perfiles-de-acceso-por-agente)  Perfiles de acceso por agente
...
Consulta [Sandbox y herramientas multiagente](https://docs.openclaw.ai/es/tools/multi-agent-sandbox-tools) para detalles de precedencia.

* * *

## [​](https://docs.openclaw.ai/es/gateway/config-agents\#sesi%C3%B3n)  Sesión
...
## [​](https://docs.openclaw.ai/es/gateway/config-agents\#mensajes)  Mensajes
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#prefijo-de-respuesta)  Prefijo de respuesta

Anulaciones por canal/cuenta: `channels.<channel>.responsePrefix`, `channels.<channel>.accounts.<id>.responsePrefix`.Resolución (gana lo más específico): cuenta → canal → global. `""` desactiva y detiene la cascada. `"auto"` deriva `[{identity.name}]`.**Variables de plantilla:**
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#reacci%C3%B3n-de-acuse)  Reacción de acuse
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#debounce-de-entrada)  Debounce de entrada
...
### [​](https://docs.openclaw.ai/es/gateway/config-agents\#tts-texto-a-voz)  TTS (texto a voz)
...
## [​](https://docs.openclaw.ai/es/gateway/config-agents\#talk)  Talk
...
## [​](https://docs.openclaw.ai/es/gateway/config-agents\#relacionado)  Relacionado

- [Referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference) — todas las demás claves de configuración
- [Configuración](https://docs.openclaw.ai/es/gateway/configuration) — tareas comunes y configuración rápida
- [Ejemplos de configuración](https://docs.openclaw.ai/es/gateway/configuration-examples)

[Referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference) [Configuración — canales](https://docs.openclaw.ai/es/gateway/config-channels)
