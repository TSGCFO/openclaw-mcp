...
[Saltar al contenido principal](https://docs.openclaw.ai/es/gateway/configuration#content-area)
...
- [Configuración mínima](https://docs.openclaw.ai/es/gateway/configuration#configuraci%C3%B3n-m%C3%ADnima)
- [Editar la configuración](https://docs.openclaw.ai/es/gateway/configuration#editar-la-configuraci%C3%B3n)
- [Validación estricta](https://docs.openclaw.ai/es/gateway/configuration#validaci%C3%B3n-estricta)
- [Tareas comunes](https://docs.openclaw.ai/es/gateway/configuration#tareas-comunes)
- [Recarga en caliente de la configuración](https://docs.openclaw.ai/es/gateway/configuration#recarga-en-caliente-de-la-configuraci%C3%B3n)
- [Modos de recarga](https://docs.openclaw.ai/es/gateway/configuration#modos-de-recarga)
- [Qué se aplica en caliente y qué necesita reinicio](https://docs.openclaw.ai/es/gateway/configuration#qu%C3%A9-se-aplica-en-caliente-y-qu%C3%A9-necesita-reinicio)
- [Planificación de recarga](https://docs.openclaw.ai/es/gateway/configuration#planificaci%C3%B3n-de-recarga)
- [RPC de configuración (actualizaciones programáticas)](https://docs.openclaw.ai/es/gateway/configuration#rpc-de-configuraci%C3%B3n-actualizaciones-program%C3%A1ticas)
- [Variables de entorno](https://docs.openclaw.ai/es/gateway/configuration#variables-de-entorno)
- [Referencia completa](https://docs.openclaw.ai/es/gateway/configuration#referencia-completa)
- [Relacionado](https://docs.openclaw.ai/es/gateway/configuration#relacionado)
...
OpenClaw lee una configuración opcional **JSON5** desde `~/.openclaw/openclaw.json`.
...
directorio de estado predeterminado, apunte `OPENCLAW_CONFIG_PATH` directamente al archivo real.Si falta el archivo, OpenClaw usa valores predeterminados seguros. Razones comunes para agregar una configuración:
...
Consulte la [referencia completa](https://docs.openclaw.ai/es/gateway/configuration-reference) para ver todos los campos disponibles.Los agentes y la automatización deben usar `config.schema.lookup` para obtener documentación exacta
a nivel de campo antes de editar la configuración. Use esta página para orientación orientada a tareas y la
[referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference) para el mapa de campos más amplio
y los valores predeterminados.

**¿Nuevo en la configuración?** Comience con `openclaw onboard` para la configuración interactiva, o consulte la guía de [ejemplos de configuración](https://docs.openclaw.ai/es/gateway/configuration-examples) para obtener configuraciones completas listas para copiar y pegar.

## [​](https://docs.openclaw.ai/es/gateway/configuration\#configuraci%C3%B3n-m%C3%ADnima)  Configuración mínima
...
## [​](https://docs.openclaw.ai/es/gateway/configuration\#editar-la-configuraci%C3%B3n)  Editar la configuración
...
Edite `~/.openclaw/openclaw.json` directamente. El Gateway vigila el archivo y aplica los cambios automáticamente (consulte [recarga en caliente](https://docs.openclaw.ai/es/gateway/configuration#config-hot-reload)).

## [​](https://docs.openclaw.ai/es/gateway/configuration\#validaci%C3%B3n-estricta)  Validación estricta
...
se carga el registro de manifiestos.Cuando falla la validación:
...
## [​](https://docs.openclaw.ai/es/gateway/configuration\#tareas-comunes)  Tareas comunes
...
- [WhatsApp](https://docs.openclaw.ai/es/channels/whatsapp) — `channels.whatsapp`
- [Telegram](https://docs.openclaw.ai/es/channels/telegram) — `channels.telegram`
- [Discord](https://docs.openclaw.ai/es/channels/discord) — `channels.discord`
- [Feishu](https://docs.openclaw.ai/es/channels/feishu) — `channels.feishu`
- [Google Chat](https://docs.openclaw.ai/es/channels/googlechat) — `channels.googlechat`
- [Microsoft Teams](https://docs.openclaw.ai/es/channels/msteams) — `channels.msteams`
- [Slack](https://docs.openclaw.ai/es/channels/slack) — `channels.slack`
- [Signal](https://docs.openclaw.ai/es/channels/signal) — `channels.signal`
- [iMessage](https://docs.openclaw.ai/es/channels/imessage) — `channels.imessage`
- [Mattermost](https://docs.openclaw.ai/es/channels/mattermost) — `channels.mattermost`
...
- Consulte [CLI de modelos](https://docs.openclaw.ai/es/concepts/models) para cambiar modelos en el chat y [conmutación por error de modelos](https://docs.openclaw.ai/es/concepts/model-failover) para la rotación de autenticación y el comportamiento de fallback.
- Para proveedores personalizados/autohospedados, consulte [proveedores personalizados](https://docs.openclaw.ai/es/gateway/config-tools#custom-providers-and-base-urls) en la referencia.
...
Para grupos, use `groupPolicy` \+ `groupAllowFrom` o allowlists específicas del canal.Consulte la [referencia completa](https://docs.openclaw.ai/es/gateway/config-channels#dm-and-group-access) para ver detalles por canal.
...
- Consulte la [referencia completa](https://docs.openclaw.ai/es/gateway/config-channels#group-chat-mention-gating) para modos de respuesta visible, sobrescrituras por canal y modo de chat consigo mismo.
...
- Consulte [Skills](https://docs.openclaw.ai/es/tools/skills), [configuración de Skills](https://docs.openclaw.ai/es/tools/skills-config) y
la [referencia de configuración](https://docs.openclaw.ai/es/gateway/config-agents#agents-defaults-skills).
...
- Consulte [comprobaciones de estado](https://docs.openclaw.ai/es/gateway/health) para depuración operativa y la [referencia completa](https://docs.openclaw.ai/es/gateway/configuration-reference#gateway) para todos los campos.
...
- Consulta [Gestión de sesiones](https://docs.openclaw.ai/es/concepts/session) para el alcance, los enlaces de identidad y la política de envío.
- Consulta la [referencia completa](https://docs.openclaw.ai/es/gateway/config-agents#session) para todos los campos.
...
Crea la imagen primero: desde un checkout del código fuente, ejecuta `scripts/sandbox-setup.sh`; o, desde una instalación npm, consulta el comando `docker build` en línea en [Sandboxing § Imágenes y configuración](https://docs.openclaw.ai/es/gateway/sandboxing#images-and-setup).Consulta [Sandboxing](https://docs.openclaw.ai/es/gateway/sandboxing) para la guía completa y la [referencia completa](https://docs.openclaw.ai/es/gateway/config-agents#agentsdefaultssandbox) para todas las opciones.

Habilitar push respaldado por relay para builds oficiales de iOS

El push respaldado por relay se configura en `openclaw.json`.Define esto en la configuración del gateway:
...
Consulta [App iOS](https://docs.openclaw.ai/es/platforms/ios#relay-backed-push-for-official-builds) para el flujo de extremo a extremo y [Flujo de autenticación y confianza](https://docs.openclaw.ai/es/platforms/ios#authentication-and-trust-flow) para el modelo de seguridad del relay.

Configurar Heartbeat (registros periódicos)
...
- Consulta [Heartbeat](https://docs.openclaw.ai/es/gateway/heartbeat) para la guía completa.
...
- Consulta [Trabajos Cron](https://docs.openclaw.ai/es/automation/cron-jobs) para una descripción general de la función y ejemplos de CLI.
...
Consulta la [referencia completa](https://docs.openclaw.ai/es/gateway/configuration-reference#hooks) para todas las opciones de mapeo y la integración con Gmail.
...
Consulta [Multi-Agent](https://docs.openclaw.ai/es/concepts/multi-agent) y la [referencia completa](https://docs.openclaw.ai/es/gateway/config-agents#multi-agent-routing) para las reglas de vinculación y los perfiles de acceso por agente.
...
## [​](https://docs.openclaw.ai/es/gateway/configuration\#recarga-en-caliente-de-la-configuraci%C3%B3n)  Recarga en caliente de la configuración

El Gateway observa `~/.openclaw/openclaw.json` y aplica los cambios automáticamente; no se necesita reinicio manual para la mayoría de los ajustes.Las ediciones directas de archivos se tratan como no confiables hasta que se validan. El watcher espera
...
y se guardan como `.rejected.*` para inspección.Los fallos de validación locales del Plugin son la excepción: si todos los problemas están bajo
`plugins.entries.<id>...`, la recarga conserva la configuración actual e informa el problema del Plugin
en lugar de restaurar `.last-good`.Si ves `Config auto-restored from last-known-good` o
...
`openclaw config validate`. Consulta [Solución de problemas del Gateway](https://docs.openclaw.ai/es/gateway/troubleshooting#gateway-restored-last-known-good-config)
para la lista de recuperación.

### [​](https://docs.openclaw.ai/es/gateway/configuration\#modos-de-recarga)  Modos de recarga
...
### [​](https://docs.openclaw.ai/es/gateway/configuration\#qu%C3%A9-se-aplica-en-caliente-y-qu%C3%A9-necesita-reinicio)  Qué se aplica en caliente y qué necesita reinicio
...
### [​](https://docs.openclaw.ai/es/gateway/configuration\#planificaci%C3%B3n-de-recarga)  Planificación de recarga
...
## [​](https://docs.openclaw.ai/es/gateway/configuration\#rpc-de-configuraci%C3%B3n-actualizaciones-program%C3%A1ticas)  RPC de configuración (actualizaciones programáticas)
...
a nivel de campo. Usa [Referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference)
...
## [​](https://docs.openclaw.ai/es/gateway/configuration\#variables-de-entorno)  Variables de entorno
...
Los detalles de SecretRef (incluido `secrets.providers` para `env`/`file`/`exec`) están en [Gestión de secretos](https://docs.openclaw.ai/es/gateway/secrets).
Las rutas de credenciales admitidas se enumeran en [Superficie de credenciales SecretRef](https://docs.openclaw.ai/es/reference/secretref-credential-surface).

Consulta [Entorno](https://docs.openclaw.ai/es/help/environment) para ver la precedencia y las fuentes completas.

## [​](https://docs.openclaw.ai/es/gateway/configuration\#referencia-completa)  Referencia completa

Para obtener la referencia completa campo por campo, consulta **[Referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference)**.

* * *

_Relacionado: [Ejemplos de configuración](https://docs.openclaw.ai/es/gateway/configuration-examples) · [Referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference) · [Doctor](https://docs.openclaw.ai/es/gateway/doctor)_

## [​](https://docs.openclaw.ai/es/gateway/configuration\#relacionado)  Relacionado

- [Referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference)
- [Ejemplos de configuración](https://docs.openclaw.ai/es/gateway/configuration-examples)
- [Runbook de Gateway](https://docs.openclaw.ai/es/gateway)

[Guía operativa de Gateway](https://docs.openclaw.ai/es/gateway) [Referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference)
