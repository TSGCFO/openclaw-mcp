...
title: "Modelos locales - OpenClaw"
---

[Saltar al contenido principal](https://docs.openclaw.ai/es/gateway/local-models#content-area)
...
- [Recomendado: LM Studio + modelo local grande (Responses API)](https://docs.openclaw.ai/es/gateway/local-models#recomendado-lm-studio-%2B-modelo-local-grande-responses-api)
- [Configuración híbrida: primario alojado, fallback local](https://docs.openclaw.ai/es/gateway/local-models#configuraci%C3%B3n-h%C3%ADbrida-primario-alojado-fallback-local)
- [Prioridad local con red de seguridad alojada](https://docs.openclaw.ai/es/gateway/local-models#prioridad-local-con-red-de-seguridad-alojada)
- [Alojamiento regional / enrutamiento de datos](https://docs.openclaw.ai/es/gateway/local-models#alojamiento-regional-%2F-enrutamiento-de-datos)
- [Otros proxies locales compatibles con OpenAI](https://docs.openclaw.ai/es/gateway/local-models#otros-proxies-locales-compatibles-con-openai)
- [Solución de problemas](https://docs.openclaw.ai/es/gateway/local-models#soluci%C3%B3n-de-problemas)
- [Relacionado](https://docs.openclaw.ai/es/gateway/local-models#relacionado)
...
### [​](https://docs.openclaw.ai/es/gateway/local-models\#configuraci%C3%B3n-h%C3%ADbrida-primario-alojado-fallback-local)  Configuración híbrida: primario alojado, fallback local
...
### [​](https://docs.openclaw.ai/es/gateway/local-models\#prioridad-local-con-red-de-seguridad-alojada)  Prioridad local con red de seguridad alojada
...
### [​](https://docs.openclaw.ai/es/gateway/local-models\#alojamiento-regional-/-enrutamiento-de-datos)  Alojamiento regional / enrutamiento de datos
...
## [​](https://docs.openclaw.ai/es/gateway/local-models\#otros-proxies-locales-compatibles-con-openai)  Otros proxies locales compatibles con OpenAI
...
[Funciones experimentales](https://docs.openclaw.ai/es/concepts/experimental-features). Si eso sigue fallando, prueba
...
## [​](https://docs.openclaw.ai/es/gateway/local-models\#soluci%C3%B3n-de-problemas)  Solución de problemas
...
## [​](https://docs.openclaw.ai/es/gateway/local-models\#relacionado)  Relacionado

- [Referencia de configuración](https://docs.openclaw.ai/es/gateway/configuration-reference)
- [Conmutación por error de modelos](https://docs.openclaw.ai/es/concepts/model-failover)

[Backends de CLI](https://docs.openclaw.ai/es/gateway/cli-backends) [Red](https://docs.openclaw.ai/es/network)
