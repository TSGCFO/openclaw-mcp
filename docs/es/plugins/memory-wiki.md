...
title: "Wiki de memoria - OpenClaw"
---

[Saltar al contenido principal](https://docs.openclaw.ai/es/plugins/memory-wiki#content-area)
...
- [Qué añade](https://docs.openclaw.ai/es/plugins/memory-wiki#qu%C3%A9-a%C3%B1ade)
- [Cómo encaja con la memoria](https://docs.openclaw.ai/es/plugins/memory-wiki#c%C3%B3mo-encaja-con-la-memoria)
- [Patrón híbrido recomendado](https://docs.openclaw.ai/es/plugins/memory-wiki#patr%C3%B3n-h%C3%ADbrido-recomendado)
- [Modos de bóveda](https://docs.openclaw.ai/es/plugins/memory-wiki#modos-de-b%C3%B3veda)
- [isolated](https://docs.openclaw.ai/es/plugins/memory-wiki#isolated)
- [bridge](https://docs.openclaw.ai/es/plugins/memory-wiki#bridge)
- [unsafe-local](https://docs.openclaw.ai/es/plugins/memory-wiki#unsafe-local)
- [Diseño de la bóveda](https://docs.openclaw.ai/es/plugins/memory-wiki#dise%C3%B1o-de-la-b%C3%B3veda)
- [Afirmaciones estructuradas y evidencias](https://docs.openclaw.ai/es/plugins/memory-wiki#afirmaciones-estructuradas-y-evidencias)
- [Metadatos de entidades orientados a agentes](https://docs.openclaw.ai/es/plugins/memory-wiki#metadatos-de-entidades-orientados-a-agentes)
- [Canalización de compilación](https://docs.openclaw.ai/es/plugins/memory-wiki#canalizaci%C3%B3n-de-compilaci%C3%B3n)
- [Paneles e informes de estado](https://docs.openclaw.ai/es/plugins/memory-wiki#paneles-e-informes-de-estado)
- [Búsqueda y recuperación](https://docs.openclaw.ai/es/plugins/memory-wiki#b%C3%BAsqueda-y-recuperaci%C3%B3n)
- [Herramientas de agente](https://docs.openclaw.ai/es/plugins/memory-wiki#herramientas-de-agente)
- [Comportamiento de prompt y contexto](https://docs.openclaw.ai/es/plugins/memory-wiki#comportamiento-de-prompt-y-contexto)
- [Configuración](https://docs.openclaw.ai/es/plugins/memory-wiki#configuraci%C3%B3n)
- [Ejemplo: modo QMD + puente](https://docs.openclaw.ai/es/plugins/memory-wiki#ejemplo-modo-qmd-%2B-puente)
- [CLI](https://docs.openclaw.ai/es/plugins/memory-wiki#cli)
- [Compatibilidad con Obsidian](https://docs.openclaw.ai/es/plugins/memory-wiki#compatibilidad-con-obsidian)
- [Flujo de trabajo recomendado](https://docs.openclaw.ai/es/plugins/memory-wiki#flujo-de-trabajo-recomendado)
- [Documentación relacionada](https://docs.openclaw.ai/es/plugins/memory-wiki#documentaci%C3%B3n-relacionada)
...
`memory-wiki` es un plugin incluido que convierte la memoria duradera en una bóveda de conocimiento compilada.**No** reemplaza al plugin de memoria activa. El plugin de memoria activa sigue
...
afirmaciones estructuradas, procedencia, paneles y resúmenes legibles por máquina.Úsalo cuando quieras que la memoria se comporte más como una capa de conocimiento mantenida y
menos como una pila de archivos Markdown.

## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#qu%C3%A9-a%C3%B1ade)  Qué añade
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#c%C3%B3mo-encaja-con-la-memoria)  Cómo encaja con la memoria
...
en ambas capas en una sola pasada con `memory_search corpus=all`.Cuando necesites clasificación específica de wiki, procedencia o acceso directo a páginas, usa las
herramientas nativas de la wiki.

## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#patr%C3%B3n-h%C3%ADbrido-recomendado)  Patrón híbrido recomendado
...
luego confirma que el plugin de memoria activa admita artefactos públicos.Cuando el modo puente está activo y `bridge.readMemoryArtifacts` está habilitado,
`openclaw wiki status`, `openclaw wiki doctor` y `openclaw wiki bridge import` leen a través del Gateway en ejecución. Eso mantiene las comprobaciones de puente de la CLI alineadas
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#modos-de-b%C3%B3veda)  Modos de bóveda

`memory-wiki` admite tres modos de bóveda:

### [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#isolated)  `isolated`

Bóveda propia, fuentes propias, sin dependencia de `memory-core`.Usa esto cuando quieras que la wiki sea su propio almacén de conocimiento curado.

### [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#bridge)  `bridge`

Lee artefactos públicos de memoria y eventos de memoria del plugin de memoria activa
a través de puntos de unión públicos del SDK de plugins.Usa esto cuando quieras que la wiki compile y organice los artefactos exportados del plugin de memoria
sin acceder a componentes internos privados del plugin.El modo puente puede indexar:
...
### [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#unsafe-local)  `unsafe-local`

Vía de escape explícita en la misma máquina para rutas privadas locales.Este modo es intencionalmente experimental y no portable. Úsalo solo cuando
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#dise%C3%B1o-de-la-b%C3%B3veda)  Diseño de la bóveda
...
El contenido administrado permanece dentro de bloques generados. Los bloques de notas humanas se conservan.Los principales grupos de páginas son:
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#afirmaciones-estructuradas-y-evidencias)  Afirmaciones estructuradas y evidencias

Las páginas pueden llevar frontmatter `claims` estructurado, no solo texto libre.Cada afirmación puede incluir:
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#metadatos-de-entidades-orientados-a-agentes)  Metadatos de entidades orientados a agentes
...
tipo de entidad.Los campos comunes incluyen:
...
antes de usar detalles de contacto o hechos inferidos.Ejemplo:
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#canalizaci%C3%B3n-de-compilaci%C3%B3n)  Canalización de compilación
...
Markdown.La salida compilada también impulsa:
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#paneles-e-informes-de-estado)  Paneles e informes de estado

Cuando `render.createDashboards` está habilitado, la compilación mantiene paneles en
`reports/`.Los informes integrados incluyen:
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#b%C3%BAsqueda-y-recuperaci%C3%B3n)  Búsqueda y recuperación
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#herramientas-de-agente)  Herramientas de agente
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#comportamiento-de-prompt-y-contexto)  Comportamiento de prompt y contexto

Cuando `context.includeCompiledDigestPrompt` está habilitado, las secciones de prompt de memoria
añaden una instantánea compilada compacta de `agent-digest.json`.Esa instantánea es intencionalmente pequeña y de alta señal:
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#configuraci%C3%B3n)  Configuración
...
### [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#ejemplo-modo-qmd-+-puente)  Ejemplo: modo QMD + puente
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#cli)  CLI
...
Consulta [CLI: wiki](https://docs.openclaw.ai/es/cli/wiki) para ver la referencia completa de comandos.

## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#compatibilidad-con-obsidian)  Compatibilidad con Obsidian

Cuando `vault.renderMode` es `obsidian`, el Plugin escribe Markdown compatible con Obsidian
y puede usar opcionalmente la CLI oficial `obsidian`.Los flujos de trabajo compatibles incluyen:
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#flujo-de-trabajo-recomendado)  Flujo de trabajo recomendado
...
## [​](https://docs.openclaw.ai/es/plugins/memory-wiki\#documentaci%C3%B3n-relacionada)  Documentación relacionada

- [Descripción general de memoria](https://docs.openclaw.ai/es/concepts/memory)
- [CLI: memory](https://docs.openclaw.ai/es/cli/memory)
- [CLI: wiki](https://docs.openclaw.ai/es/cli/wiki)
- [Descripción general del SDK de Plugin](https://docs.openclaw.ai/es/plugins/sdk-overview)

[Voice call](https://docs.openclaw.ai/es/plugins/voice-call) [Memory LanceDB](https://docs.openclaw.ai/es/plugins/memory-lancedb)
