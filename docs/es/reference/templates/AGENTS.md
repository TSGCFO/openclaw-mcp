---
source_url: https://docs.openclaw.ai/es/reference/templates/AGENTS#plantilla-de-agents-md
title: "Plantilla de AGENTS.md - OpenClaw"
---

[Saltar al contenido principal](https://docs.openclaw.ai/es/reference/templates/AGENTS#content-area)
...
- [AGENTS.md - Tu espacio de trabajo](https://docs.openclaw.ai/es/reference/templates/AGENTS#agents-md-tu-espacio-de-trabajo)
- [Primera ejecución](https://docs.openclaw.ai/es/reference/templates/AGENTS#primera-ejecuci%C3%B3n)
- [Inicio de sesión](https://docs.openclaw.ai/es/reference/templates/AGENTS#inicio-de-sesi%C3%B3n)
- [Memoria](https://docs.openclaw.ai/es/reference/templates/AGENTS#memoria)
- [🧠 MEMORY.md - Tu memoria a largo plazo](https://docs.openclaw.ai/es/reference/templates/AGENTS#-memory-md-tu-memoria-a-largo-plazo)
- [📝 Escríbelo - ¡Nada de “notas mentales”!](https://docs.openclaw.ai/es/reference/templates/AGENTS#-escr%C3%ADbelo-%C2%A1nada-de-%E2%80%9Cnotas-mentales%E2%80%9D)
- [Líneas rojas](https://docs.openclaw.ai/es/reference/templates/AGENTS#l%C3%ADneas-rojas)
- [Externo vs interno](https://docs.openclaw.ai/es/reference/templates/AGENTS#externo-vs-interno)
- [Chats grupales](https://docs.openclaw.ai/es/reference/templates/AGENTS#chats-grupales)
- [💬 ¡Sabe cuándo hablar!](https://docs.openclaw.ai/es/reference/templates/AGENTS#-%C2%A1sabe-cu%C3%A1ndo-hablar)
- [😊 ¡Reacciona como un humano!](https://docs.openclaw.ai/es/reference/templates/AGENTS#-%C2%A1reacciona-como-un-humano)
- [Herramientas](https://docs.openclaw.ai/es/reference/templates/AGENTS#herramientas)
- [💓 Heartbeats - ¡Sé proactivo!](https://docs.openclaw.ai/es/reference/templates/AGENTS#-heartbeats-%C2%A1s%C3%A9-proactivo)
- [Heartbeat vs Cron: cuándo usar cada uno](https://docs.openclaw.ai/es/reference/templates/AGENTS#heartbeat-vs-cron-cu%C3%A1ndo-usar-cada-uno)
- [🔄 Mantenimiento de memoria (durante Heartbeats)](https://docs.openclaw.ai/es/reference/templates/AGENTS#-mantenimiento-de-memoria-durante-heartbeats)
- [Hazlo tuyo](https://docs.openclaw.ai/es/reference/templates/AGENTS#hazlo-tuyo)
- [Relacionado](https://docs.openclaw.ai/es/reference/templates/AGENTS#relacionado)
...
# [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#agents-md-tu-espacio-de-trabajo)  AGENTS.md - Tu espacio de trabajo

Esta carpeta es el hogar. Trátala como tal.

## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#primera-ejecuci%C3%B3n)  Primera ejecución
...
## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#inicio-de-sesi%C3%B3n)  Inicio de sesión
...
## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#memoria)  Memoria
...
### [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#-memory-md-tu-memoria-a-largo-plazo)  🧠 MEMORY.md - Tu memoria a largo plazo
...
### [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#-escr%C3%ADbelo-%C2%A1nada-de-%E2%80%9Cnotas-mentales%E2%80%9D)  📝 Escríbelo - ¡Nada de “notas mentales”!
...
## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#l%C3%ADneas-rojas)  Líneas rojas
...
## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#externo-vs-interno)  Externo vs interno
...
## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#chats-grupales)  Chats grupales
...
### [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#-%C2%A1sabe-cu%C3%A1ndo-hablar)  💬 ¡Sabe cuándo hablar!
...
### [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#-%C2%A1reacciona-como-un-humano)  😊 ¡Reacciona como un humano!
...
## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#herramientas)  Herramientas
...
## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#-heartbeats-%C2%A1s%C3%A9-proactivo)  💓 Heartbeats - ¡Sé proactivo!
...
### [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#heartbeat-vs-cron-cu%C3%A1ndo-usar-cada-uno)  Heartbeat vs Cron: cuándo usar cada uno
...
### [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#-mantenimiento-de-memoria-durante-heartbeats)  🔄 Mantenimiento de memoria (durante Heartbeats)
...
## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#hazlo-tuyo)  Hazlo tuyo

Este es un punto de partida. Agrega tus propias convenciones, estilo y reglas a medida que descubras qué funciona.

## [​](https://docs.openclaw.ai/es/reference/templates/AGENTS\#relacionado)  Relacionado
