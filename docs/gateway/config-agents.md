...
title: "Configuration \u2014 agents - OpenClaw"
---
...
- [agents.defaults.skipOptionalBootstrapFiles](https://docs.openclaw.ai/gateway/config-agents#agents-defaults-skipoptionalbootstrapfiles)
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-defaults-skipoptionalbootstrapfiles)  `agents.defaults.skipOptionalBootstrapFiles`
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-defaults-agentruntime)  `agents.defaults.agentRuntime`
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-defaults-clibackends)  `agents.defaults.cliBackends`
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-defaults-systempromptoverride)  `agents.defaults.systemPromptOverride`
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-defaults-promptoverlays)  `agents.defaults.promptOverlays`
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-defaults-heartbeat)  `agents.defaults.heartbeat`
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-defaults-compaction)  `agents.defaults.compaction`
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-defaults-contextpruning)  `agents.defaults.contextPruning`
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#block-streaming)  Block streaming
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#typing-indicators)  Typing indicators
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-defaults-sandbox)  `agents.defaults.sandbox`
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#agents-list-per-agent-overrides)  `agents.list` (per-agent overrides)
...
## [​](https://docs.openclaw.ai/gateway/config-agents\#multi-agent-routing)  Multi-agent routing
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#binding-match-fields)  Binding match fields
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#per-agent-access-profiles)  Per-agent access profiles
...
## [​](https://docs.openclaw.ai/gateway/config-agents\#session)  Session
...
## [​](https://docs.openclaw.ai/gateway/config-agents\#messages)  Messages
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#response-prefix)  Response prefix
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#ack-reaction)  Ack reaction
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#inbound-debounce)  Inbound debounce
...
### [​](https://docs.openclaw.ai/gateway/config-agents\#tts-text-to-speech)  TTS (text-to-speech)
...
## [​](https://docs.openclaw.ai/gateway/config-agents\#talk)  Talk
...
## [​](https://docs.openclaw.ai/gateway/config-agents\#related)  Related
