...
- [Commitments](https://docs.openclaw.ai/gateway/configuration-reference#commitments)
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#commitments)  Commitments
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#gateway-tls)  `gateway.tls`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#gateway-reload)  `gateway.reload`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#auth-cooldowns)  `auth.cooldowns`
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#diagnostics)  Diagnostics
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#update)  Update
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#acp)  ACP
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#cron-retry)  `cron.retry`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#cron-failurealert)  `cron.failureAlert`
...
### [​](https://docs.openclaw.ai/gateway/configuration-reference\#cron-failuredestination)  `cron.failureDestination`
...
## [​](https://docs.openclaw.ai/gateway/configuration-reference\#related)  Related
