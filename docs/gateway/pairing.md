...
- [Node command gating (2026.3.31+)](https://docs.openclaw.ai/gateway/pairing#node-command-gating-2026-3-31%2B)
- [Node event trust boundaries (2026.3.31+)](https://docs.openclaw.ai/gateway/pairing#node-event-trust-boundaries-2026-3-31%2B)
- [Auto-approval (macOS app)](https://docs.openclaw.ai/gateway/pairing#auto-approval-macos-app)
- [Trusted-CIDR device auto-approval](https://docs.openclaw.ai/gateway/pairing#trusted-cidr-device-auto-approval)
- [Metadata-upgrade auto-approval](https://docs.openclaw.ai/gateway/pairing#metadata-upgrade-auto-approval)
- [QR pairing helpers](https://docs.openclaw.ai/gateway/pairing#qr-pairing-helpers)
- [Locality and forwarded headers](https://docs.openclaw.ai/gateway/pairing#locality-and-forwarded-headers)
...
- [Related](https://docs.openclaw.ai/gateway/pairing#related)
...
## [​](https://docs.openclaw.ai/gateway/pairing\#node-command-gating-2026-3-31+)  Node command gating (2026.3.31+)
...
## [​](https://docs.openclaw.ai/gateway/pairing\#node-event-trust-boundaries-2026-3-31+)  Node event trust boundaries (2026.3.31+)
...
## [​](https://docs.openclaw.ai/gateway/pairing\#trusted-cidr-device-auto-approval)  Trusted-CIDR device auto-approval
...
## [​](https://docs.openclaw.ai/gateway/pairing\#metadata-upgrade-auto-approval)  Metadata-upgrade auto-approval
...
## [​](https://docs.openclaw.ai/gateway/pairing\#qr-pairing-helpers)  QR pairing helpers
...
## [​](https://docs.openclaw.ai/gateway/pairing\#locality-and-forwarded-headers)  Locality and forwarded headers
...
## [​](https://docs.openclaw.ai/gateway/pairing\#related)  Related
