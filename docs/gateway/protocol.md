...
- [Node background alive event](https://docs.openclaw.ai/gateway/protocol#node-background-alive-event)
- [Broadcast event scoping](https://docs.openclaw.ai/gateway/protocol#broadcast-event-scoping)
- [Common RPC method families](https://docs.openclaw.ai/gateway/protocol#common-rpc-method-families)
...
- [models.list views](https://docs.openclaw.ai/gateway/protocol#models-list-views)
- [Exec approvals](https://docs.openclaw.ai/gateway/protocol#exec-approvals)
- [Agent delivery fallback](https://docs.openclaw.ai/gateway/protocol#agent-delivery-fallback)
- [Versioning](https://docs.openclaw.ai/gateway/protocol#versioning)
- [Client constants](https://docs.openclaw.ai/gateway/protocol#client-constants)
...
- [Related](https://docs.openclaw.ai/gateway/protocol#related)
...
### [​](https://docs.openclaw.ai/gateway/protocol\#node-background-alive-event)  Node background alive event
...
## [​](https://docs.openclaw.ai/gateway/protocol\#broadcast-event-scoping)  Broadcast event scoping
...
### [​](https://docs.openclaw.ai/gateway/protocol\#models-list-views)  `models.list` views
...
### [​](https://docs.openclaw.ai/gateway/protocol\#client-constants)  Client constants
...
## [​](https://docs.openclaw.ai/gateway/protocol\#related)  Related
