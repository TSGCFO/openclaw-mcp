...
- [Backend](https://docs.openclaw.ai/gateway/sandboxing#backend)
- [Choosing a backend](https://docs.openclaw.ai/gateway/sandboxing#choosing-a-backend)
- [Docker backend](https://docs.openclaw.ai/gateway/sandboxing#docker-backend)
- [SSH backend](https://docs.openclaw.ai/gateway/sandboxing#ssh-backend)
- [OpenShell backend](https://docs.openclaw.ai/gateway/sandboxing#openshell-backend)
- [Workspace modes](https://docs.openclaw.ai/gateway/sandboxing#workspace-modes)
- [OpenShell lifecycle](https://docs.openclaw.ai/gateway/sandboxing#openshell-lifecycle)
...
- [Images and setup](https://docs.openclaw.ai/gateway/sandboxing#images-and-setup)
- [setupCommand (one-time container setup)](https://docs.openclaw.ai/gateway/sandboxing#setupcommand-one-time-container-setup)
- [Tool policy and escape hatches](https://docs.openclaw.ai/gateway/sandboxing#tool-policy-and-escape-hatches)
...
- [Related](https://docs.openclaw.ai/gateway/sandboxing#related)
...
## [​](https://docs.openclaw.ai/gateway/sandboxing\#backend)  Backend
...
### [​](https://docs.openclaw.ai/gateway/sandboxing\#choosing-a-backend)  Choosing a backend
...
### [​](https://docs.openclaw.ai/gateway/sandboxing\#docker-backend)  Docker backend
...
### [​](https://docs.openclaw.ai/gateway/sandboxing\#ssh-backend)  SSH backend
...
### [​](https://docs.openclaw.ai/gateway/sandboxing\#openshell-backend)  OpenShell backend
...
#### [​](https://docs.openclaw.ai/gateway/sandboxing\#workspace-modes)  Workspace modes
...
#### [​](https://docs.openclaw.ai/gateway/sandboxing\#openshell-lifecycle)  OpenShell lifecycle
...
## [​](https://docs.openclaw.ai/gateway/sandboxing\#images-and-setup)  Images and setup
...
## [​](https://docs.openclaw.ai/gateway/sandboxing\#tool-policy-and-escape-hatches)  Tool policy and escape hatches
...
## [​](https://docs.openclaw.ai/gateway/sandboxing\#related)  Related
