...
title: "Secrets management - OpenClaw"
---
...
## [​](https://docs.openclaw.ai/gateway/secrets\#legacy-auth-compatibility-notes)  Legacy auth compatibility notes
...
## [​](https://docs.openclaw.ai/gateway/secrets\#web-ui-note)  Web UI note

Some SecretInput unions are easier to configure in raw editor mode than in form mode.

## [​](https://docs.openclaw.ai/gateway/secrets\#related)  Related
