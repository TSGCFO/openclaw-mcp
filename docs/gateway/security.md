...
- [Scope first: personal assistant security model](https://docs.openclaw.ai/gateway/security#scope-first-personal-assistant-security-model)
- [Quick check: openclaw security audit](https://docs.openclaw.ai/gateway/security#quick-check-openclaw-security-audit)
- [Deployment and host trust](https://docs.openclaw.ai/gateway/security#deployment-and-host-trust)
- [Shared Slack workspace: real risk](https://docs.openclaw.ai/gateway/security#shared-slack-workspace-real-risk)
- [Company-shared agent: acceptable pattern](https://docs.openclaw.ai/gateway/security#company-shared-agent-acceptable-pattern)
- [Gateway and node trust concept](https://docs.openclaw.ai/gateway/security#gateway-and-node-trust-concept)
- [Trust boundary matrix](https://docs.openclaw.ai/gateway/security#trust-boundary-matrix)
- [Not vulnerabilities by design](https://docs.openclaw.ai/gateway/security#not-vulnerabilities-by-design)
- [Hardened baseline in 60 seconds](https://docs.openclaw.ai/gateway/security#hardened-baseline-in-60-seconds)
- [Shared inbox quick rule](https://docs.openclaw.ai/gateway/security#shared-inbox-quick-rule)
- [Context visibility model](https://docs.openclaw.ai/gateway/security#context-visibility-model)
...
- [Security audit glossary](https://docs.openclaw.ai/gateway/security#security-audit-glossary)
- [Control UI over HTTP](https://docs.openclaw.ai/gateway/security#control-ui-over-http)
- [Insecure or dangerous flags summary](https://docs.openclaw.ai/gateway/security#insecure-or-dangerous-flags-summary)
- [Reverse proxy configuration](https://docs.openclaw.ai/gateway/security#reverse-proxy-configuration)
- [HSTS and origin notes](https://docs.openclaw.ai/gateway/security#hsts-and-origin-notes)
...
- [Core concept: access control before intelligence](https://docs.openclaw.ai/gateway/security#core-concept-access-control-before-intelligence)
- [Command authorization model](https://docs.openclaw.ai/gateway/security#command-authorization-model)
- [Control plane tools risk](https://docs.openclaw.ai/gateway/security#control-plane-tools-risk)
- [Plugins](https://docs.openclaw.ai/gateway/security#plugins)
- [DM access model: pairing, allowlist, open, disabled](https://docs.openclaw.ai/gateway/security#dm-access-model-pairing-allowlist-open-disabled)
- [DM session isolation (multi-user mode)](https://docs.openclaw.ai/gateway/security#dm-session-isolation-multi-user-mode)
- [Secure DM mode (recommended)](https://docs.openclaw.ai/gateway/security#secure-dm-mode-recommended)
- [Allowlists for DMs and groups](https://docs.openclaw.ai/gateway/security#allowlists-for-dms-and-groups)
- [Prompt injection (what it is, why it matters)](https://docs.openclaw.ai/gateway/security#prompt-injection-what-it-is-why-it-matters)
- [External content special-token sanitization](https://docs.openclaw.ai/gateway/security#external-content-special-token-sanitization)
- [Unsafe external content bypass flags](https://docs.openclaw.ai/gateway/security#unsafe-external-content-bypass-flags)
...
- [Self-hosted LLM backends](https://docs.openclaw.ai/gateway/security#self-hosted-llm-backends)
- [Model strength (security note)](https://docs.openclaw.ai/gateway/security#model-strength-security-note)
- [Reasoning and verbose output in groups](https://docs.openclaw.ai/gateway/security#reasoning-and-verbose-output-in-groups)
- [Configuration hardening examples](https://docs.openclaw.ai/gateway/security#configuration-hardening-examples)
- [File permissions](https://docs.openclaw.ai/gateway/security#file-permissions)
- [Network exposure (bind, port, firewall)](https://docs.openclaw.ai/gateway/security#network-exposure-bind-port-firewall)
- [Docker port publishing with UFW](https://docs.openclaw.ai/gateway/security#docker-port-publishing-with-ufw)
- [mDNS/Bonjour discovery](https://docs.openclaw.ai/gateway/security#mdns%2Fbonjour-discovery)
- [Lock down the Gateway WebSocket (local auth)](https://docs.openclaw.ai/gateway/security#lock-down-the-gateway-websocket-local-auth)
- [Tailscale Serve identity headers](https://docs.openclaw.ai/gateway/security#tailscale-serve-identity-headers)
- [Browser control via node host (recommended)](https://docs.openclaw.ai/gateway/security#browser-control-via-node-host-recommended)
- [Secrets on disk](https://docs.openclaw.ai/gateway/security#secrets-on-disk)
- [Workspace .env files](https://docs.openclaw.ai/gateway/security#workspace-env-files)
- [Logs and transcripts (redaction and retention)](https://docs.openclaw.ai/gateway/security#logs-and-transcripts-redaction-and-retention)
- [DMs: pairing by default](https://docs.openclaw.ai/gateway/security#dms-pairing-by-default)
- [Groups: require mention everywhere](https://docs.openclaw.ai/gateway/security#groups-require-mention-everywhere)
- [Separate numbers (WhatsApp, Signal, Telegram)](https://docs.openclaw.ai/gateway/security#separate-numbers-whatsapp-signal-telegram)
- [Read-only mode (via sandbox and tools)](https://docs.openclaw.ai/gateway/security#read-only-mode-via-sandbox-and-tools)
- [Secure baseline (copy/paste)](https://docs.openclaw.ai/gateway/security#secure-baseline-copy%2Fpaste)
- [Sandboxing (recommended)](https://docs.openclaw.ai/gateway/security#sandboxing-recommended)
- [Sub-agent delegation guardrail](https://docs.openclaw.ai/gateway/security#sub-agent-delegation-guardrail)
- [Browser control risks](https://docs.openclaw.ai/gateway/security#browser-control-risks)
- [Browser SSRF policy (strict by default)](https://docs.openclaw.ai/gateway/security#browser-ssrf-policy-strict-by-default)
- [Per-agent access profiles (multi-agent)](https://docs.openclaw.ai/gateway/security#per-agent-access-profiles-multi-agent)
- [Example: full access (no sandbox)](https://docs.openclaw.ai/gateway/security#example-full-access-no-sandbox)
- [Example: read-only tools + read-only workspace](https://docs.openclaw.ai/gateway/security#example-read-only-tools-%2B-read-only-workspace)
- [Example: no filesystem/shell access (provider messaging allowed)](https://docs.openclaw.ai/gateway/security#example-no-filesystem%2Fshell-access-provider-messaging-allowed)
...
- [Secret scanning](https://docs.openclaw.ai/gateway/security#secret-scanning)
...
## [​](https://docs.openclaw.ai/gateway/security\#scope-first-personal-assistant-security-model)  Scope first: personal assistant security model
...
POSIX `chmod` when running on Windows.It flags common footguns (Gateway auth exposure, browser control exposure, elevated allowlists, filesystem permissions, permissive exec approvals, and open-channel tool exposure).OpenClaw is both a product and an experiment: you’re wiring frontier-model behavior into real messaging surfaces and real tools. **There is no “perfectly secure” setup.** The goal is to be deliberate about:
...
### [​](https://docs.openclaw.ai/gateway/security\#deployment-and-host-trust)  Deployment and host trust
...
### [​](https://docs.openclaw.ai/gateway/security\#shared-slack-workspace-real-risk)  Shared Slack workspace: real risk
...
### [​](https://docs.openclaw.ai/gateway/security\#company-shared-agent-acceptable-pattern)  Company-shared agent: acceptable pattern
...
## [​](https://docs.openclaw.ai/gateway/security\#gateway-and-node-trust-concept)  Gateway and node trust concept
...
## [​](https://docs.openclaw.ai/gateway/security\#trust-boundary-matrix)  Trust boundary matrix
...
## [​](https://docs.openclaw.ai/gateway/security\#not-vulnerabilities-by-design)  Not vulnerabilities by design
...
## [​](https://docs.openclaw.ai/gateway/security\#hardened-baseline-in-60-seconds)  Hardened baseline in 60 seconds
...
## [​](https://docs.openclaw.ai/gateway/security\#shared-inbox-quick-rule)  Shared inbox quick rule
...
## [​](https://docs.openclaw.ai/gateway/security\#context-visibility-model)  Context visibility model
...
## [​](https://docs.openclaw.ai/gateway/security\#security-audit-glossary)  Security audit glossary
...
Prefer HTTPS (Tailscale Serve) or open the UI on `127.0.0.1`.For break-glass scenarios only, `gateway.controlUi.dangerouslyDisableDeviceAuth`
disables device identity checks entirely. This is a severe security downgrade;
keep it off unless you are actively debugging and can revert quickly.Separate from those dangerous flags, successful `gateway.auth.mode: "trusted-proxy"`
...
does not extend to node-role Control UI sessions.`openclaw security audit` warns when this setting is enabled.

## [​](https://docs.openclaw.ai/gateway/security\#insecure-or-dangerous-flags-summary)  Insecure or dangerous flags summary
...
## [​](https://docs.openclaw.ai/gateway/security\#hsts-and-origin-notes)  HSTS and origin notes
...
## [​](https://docs.openclaw.ai/gateway/security\#control-plane-tools-risk)  Control plane tools risk
...
## [​](https://docs.openclaw.ai/gateway/security\#plugins)  Plugins
...
### [​](https://docs.openclaw.ai/gateway/security\#secure-dm-mode-recommended)  Secure DM mode (recommended)
...
## [​](https://docs.openclaw.ai/gateway/security\#allowlists-for-dms-and-groups)  Allowlists for DMs and groups
...
## [​](https://docs.openclaw.ai/gateway/security\#external-content-special-token-sanitization)  External content special-token sanitization
...
## [​](https://docs.openclaw.ai/gateway/security\#unsafe-external-content-bypass-flags)  Unsafe external content bypass flags
...
### [​](https://docs.openclaw.ai/gateway/security\#self-hosted-llm-backends)  Self-hosted LLM backends
...
## [​](https://docs.openclaw.ai/gateway/security\#reasoning-and-verbose-output-in-groups)  Reasoning and verbose output in groups
...
### [​](https://docs.openclaw.ai/gateway/security\#file-permissions)  File permissions
...
### [​](https://docs.openclaw.ai/gateway/security\#network-exposure-bind-port-firewall)  Network exposure (bind, port, firewall)
...
### [​](https://docs.openclaw.ai/gateway/security\#docker-port-publishing-with-ufw)  Docker port publishing with UFW
...
### [​](https://docs.openclaw.ai/gateway/security\#mdns/bonjour-discovery)  mDNS/Bonjour discovery
...
### [​](https://docs.openclaw.ai/gateway/security\#lock-down-the-gateway-websocket-local-auth)  Lock down the Gateway WebSocket (local auth)
...
### [​](https://docs.openclaw.ai/gateway/security\#tailscale-serve-identity-headers)  Tailscale Serve identity headers
...
### [​](https://docs.openclaw.ai/gateway/security\#browser-control-via-node-host-recommended)  Browser control via node host (recommended)
...
### [​](https://docs.openclaw.ai/gateway/security\#secrets-on-disk)  Secrets on disk
...
### [​](https://docs.openclaw.ai/gateway/security\#workspace-env-files)  Workspace `.env` files
...
### [​](https://docs.openclaw.ai/gateway/security\#logs-and-transcripts-redaction-and-retention)  Logs and transcripts (redaction and retention)
...
### [​](https://docs.openclaw.ai/gateway/security\#dms-pairing-by-default)  DMs: pairing by default
...
### [​](https://docs.openclaw.ai/gateway/security\#groups-require-mention-everywhere)  Groups: require mention everywhere
...
### [​](https://docs.openclaw.ai/gateway/security\#separate-numbers-whatsapp-signal-telegram)  Separate numbers (WhatsApp, Signal, Telegram)
...
### [​](https://docs.openclaw.ai/gateway/security\#read-only-mode-via-sandbox-and-tools)  Read-only mode (via sandbox and tools)
...
### [​](https://docs.openclaw.ai/gateway/security\#secure-baseline-copy/paste)  Secure baseline (copy/paste)
...
### [​](https://docs.openclaw.ai/gateway/security\#sub-agent-delegation-guardrail)  Sub-agent delegation guardrail
...
### [​](https://docs.openclaw.ai/gateway/security\#browser-ssrf-policy-strict-by-default)  Browser SSRF policy (strict by default)
...
## [​](https://docs.openclaw.ai/gateway/security\#secret-scanning)  Secret scanning
