...
title: "Testing: updates and plugins - OpenClaw"
---

[Skip to main content](https://docs.openclaw.ai/help/testing-updates-plugins#content-area)
...
- [What we protect](https://docs.openclaw.ai/help/testing-updates-plugins#what-we-protect)
- [Local proof during development](https://docs.openclaw.ai/help/testing-updates-plugins#local-proof-during-development)
- [Docker lanes](https://docs.openclaw.ai/help/testing-updates-plugins#docker-lanes)
- [Package Acceptance](https://docs.openclaw.ai/help/testing-updates-plugins#package-acceptance)
- [Release default](https://docs.openclaw.ai/help/testing-updates-plugins#release-default)
- [Legacy compatibility](https://docs.openclaw.ai/help/testing-updates-plugins#legacy-compatibility)
- [Adding coverage](https://docs.openclaw.ai/help/testing-updates-plugins#adding-coverage)
- [Failure triage](https://docs.openclaw.ai/help/testing-updates-plugins#failure-triage)
...
## [​](https://docs.openclaw.ai/help/testing-updates-plugins\#what-we-protect)  What we protect
...
## [​](https://docs.openclaw.ai/help/testing-updates-plugins\#local-proof-during-development)  Local proof during development
...
## [​](https://docs.openclaw.ai/help/testing-updates-plugins\#docker-lanes)  Docker lanes
...
## [​](https://docs.openclaw.ai/help/testing-updates-plugins\#package-acceptance)  Package Acceptance
...
## [​](https://docs.openclaw.ai/help/testing-updates-plugins\#release-default)  Release default
...
## [​](https://docs.openclaw.ai/help/testing-updates-plugins\#legacy-compatibility)  Legacy compatibility
...
## [​](https://docs.openclaw.ai/help/testing-updates-plugins\#adding-coverage)  Adding coverage
...
## [​](https://docs.openclaw.ai/help/testing-updates-plugins\#failure-triage)  Failure triage
