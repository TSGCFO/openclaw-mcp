...
### [​](https://docs.openclaw.ai/help/testing\#shared-telegram-credentials-via-convex-v1)  Shared Telegram credentials via Convex (v1)
...
### [​](https://docs.openclaw.ai/help/testing\#adding-a-channel-to-qa)  Adding a channel to QA
...
## [​](https://docs.openclaw.ai/help/testing\#test-suites-what-runs-where)  Test suites (what runs where)

Think of the suites as “increasing realism” (and increasing flakiness/cost):

### [​](https://docs.openclaw.ai/help/testing\#unit-/-integration-default)  Unit / integration (default)
...
### [​](https://docs.openclaw.ai/help/testing\#stability-gateway)  Stability (gateway)
...
### [​](https://docs.openclaw.ai/help/testing\#e2e-gateway-smoke)  E2E (gateway smoke)
...
### [​](https://docs.openclaw.ai/help/testing\#e2e-openshell-backend-smoke)  E2E: OpenShell backend smoke
...
### [​](https://docs.openclaw.ai/help/testing\#live-real-providers-+-real-models)  Live (real providers + real models)
...
## [​](https://docs.openclaw.ai/help/testing\#which-suite-should-i-run)  Which suite should I run?
...
## [​](https://docs.openclaw.ai/help/testing\#live-network-touching-tests)  Live (network-touching) tests
...
## [​](https://docs.openclaw.ai/help/testing\#docker-runners-optional-%E2%80%9Cworks-in-linux%E2%80%9D-checks)  Docker runners (optional “works in Linux” checks)
...
## [​](https://docs.openclaw.ai/help/testing\#docs-sanity)  Docs sanity
...
## [​](https://docs.openclaw.ai/help/testing\#offline-regression-ci-safe)  Offline regression (CI-safe)
...
## [​](https://docs.openclaw.ai/help/testing\#agent-reliability-evals-skills)  Agent reliability evals (skills)
...
## [​](https://docs.openclaw.ai/help/testing\#contract-tests-plugin-and-channel-shape)  Contract tests (plugin and channel shape)
...
### [​](https://docs.openclaw.ai/help/testing\#commands)  Commands
...
### [​](https://docs.openclaw.ai/help/testing\#channel-contracts)  Channel contracts
...
### [​](https://docs.openclaw.ai/help/testing\#provider-status-contracts)  Provider status contracts
...
### [​](https://docs.openclaw.ai/help/testing\#provider-contracts)  Provider contracts
...
### [​](https://docs.openclaw.ai/help/testing\#when-to-run)  When to run
...
## [​](https://docs.openclaw.ai/help/testing\#adding-regressions-guidance)  Adding regressions (guidance)
...
## [​](https://docs.openclaw.ai/help/testing\#related)  Related
