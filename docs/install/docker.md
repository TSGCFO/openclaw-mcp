...
- [Prerequisites](https://docs.openclaw.ai/install/docker#prerequisites)
- [Containerized gateway](https://docs.openclaw.ai/install/docker#containerized-gateway)
- [Manual flow](https://docs.openclaw.ai/install/docker#manual-flow)
- [Environment variables](https://docs.openclaw.ai/install/docker#environment-variables)
- [Observability](https://docs.openclaw.ai/install/docker#observability)
- [Health checks](https://docs.openclaw.ai/install/docker#health-checks)
- [LAN vs loopback](https://docs.openclaw.ai/install/docker#lan-vs-loopback)
- [Host Local Providers](https://docs.openclaw.ai/install/docker#host-local-providers)
- [Bonjour / mDNS](https://docs.openclaw.ai/install/docker#bonjour-%2F-mdns)
- [Storage and persistence](https://docs.openclaw.ai/install/docker#storage-and-persistence)
- [Shell helpers (optional)](https://docs.openclaw.ai/install/docker#shell-helpers-optional)
- [Running on a VPS?](https://docs.openclaw.ai/install/docker#running-on-a-vps)
- [Agent sandbox](https://docs.openclaw.ai/install/docker#agent-sandbox)
- [Quick enable](https://docs.openclaw.ai/install/docker#quick-enable)
- [Troubleshooting](https://docs.openclaw.ai/install/docker#troubleshooting)
- [Related](https://docs.openclaw.ai/install/docker#related)
...
- **Sandboxing note**: the default sandbox backend uses Docker when sandboxing is enabled, but sandboxing is off by default and does **not** require the full gateway to run in Docker. SSH and OpenShell sandbox backends are also available. See [Sandboxing](https://docs.openclaw.ai/gateway/sandboxing).

## [​](https://docs.openclaw.ai/install/docker\#prerequisites)  Prerequisites

- Docker Desktop (or Docker Engine) + Docker Compose v2
- At least 2 GB RAM for image build (`pnpm install` may be OOM-killed on 1 GB hosts with exit 137)
- Enough disk for images and logs
- If running on a VPS/public host, review
[Security hardening for network exposure](https://docs.openclaw.ai/gateway/security),
especially Docker `DOCKER-USER` firewall policy.

## [​](https://docs.openclaw.ai/install/docker\#containerized-gateway)  Containerized gateway

1

[Navigate to header](https://docs.openclaw.ai/install/docker#)
...
password instead.Need the URL again?
...
### [​](https://docs.openclaw.ai/install/docker\#manual-flow)  Manual flow
...
### [​](https://docs.openclaw.ai/install/docker\#environment-variables)  Environment variables
...
### [​](https://docs.openclaw.ai/install/docker\#observability)  Observability
...
### [​](https://docs.openclaw.ai/install/docker\#health-checks)  Health checks
...
### [​](https://docs.openclaw.ai/install/docker\#lan-vs-loopback)  LAN vs loopback
...
### [​](https://docs.openclaw.ai/install/docker\#host-local-providers)  Host Local Providers
...
### [​](https://docs.openclaw.ai/install/docker\#bonjour-/-mdns)  Bonjour / mDNS
...
### [​](https://docs.openclaw.ai/install/docker\#storage-and-persistence)  Storage and persistence
...
### [​](https://docs.openclaw.ai/install/docker\#shell-helpers-optional)  Shell helpers (optional)
...
### [​](https://docs.openclaw.ai/install/docker\#running-on-a-vps)  Running on a VPS?
...
## [​](https://docs.openclaw.ai/install/docker\#agent-sandbox)  Agent sandbox
...
### [​](https://docs.openclaw.ai/install/docker\#quick-enable)  Quick enable
...
## [​](https://docs.openclaw.ai/install/docker\#related)  Related
