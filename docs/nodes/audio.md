...
title: "Audio and voice notes - OpenClaw"
---
...
- [Audio / Voice Notes (2026-01-17)](https://docs.openclaw.ai/nodes/audio#audio-%2F-voice-notes-2026-01-17)
...
- [Provider-only (Mistral Voxtral)](https://docs.openclaw.ai/nodes/audio#provider-only-mistral-voxtral)
- [Provider-only (SenseAudio)](https://docs.openclaw.ai/nodes/audio#provider-only-senseaudio)
- [Echo transcript to chat (opt-in)](https://docs.openclaw.ai/nodes/audio#echo-transcript-to-chat-opt-in)
- [Notes & limits](https://docs.openclaw.ai/nodes/audio#notes-%26-limits)
- [Proxy environment support](https://docs.openclaw.ai/nodes/audio#proxy-environment-support)
- [Mention detection in groups](https://docs.openclaw.ai/nodes/audio#mention-detection-in-groups)
- [Gotchas](https://docs.openclaw.ai/nodes/audio#gotchas)
- [Related](https://docs.openclaw.ai/nodes/audio#related)
...
# [​](https://docs.openclaw.ai/nodes/audio\#audio-/-voice-notes-2026-01-17)  Audio / Voice Notes (2026-01-17)
...
### [​](https://docs.openclaw.ai/nodes/audio\#provider-only-mistral-voxtral)  Provider-only (Mistral Voxtral)
...
### [​](https://docs.openclaw.ai/nodes/audio\#provider-only-senseaudio)  Provider-only (SenseAudio)
...
### [​](https://docs.openclaw.ai/nodes/audio\#echo-transcript-to-chat-opt-in)  Echo transcript to chat (opt-in)
...
### [​](https://docs.openclaw.ai/nodes/audio\#proxy-environment-support)  Proxy environment support
...
## [​](https://docs.openclaw.ai/nodes/audio\#mention-detection-in-groups)  Mention detection in groups
...
## [​](https://docs.openclaw.ai/nodes/audio\#related)  Related
