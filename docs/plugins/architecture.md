...
- [Plugin metadata snapshot and lookup table](https://docs.openclaw.ai/plugins/architecture#plugin-metadata-snapshot-and-lookup-table)
- [Activation planning](https://docs.openclaw.ai/plugins/architecture#activation-planning)
...
- [Internals and reference](https://docs.openclaw.ai/plugins/architecture#internals-and-reference)
- [Related](https://docs.openclaw.ai/plugins/architecture#related)
...
\\
End-user guide for adding, enabling, and troubleshooting plugins.](https://docs.openclaw.ai/tools/plugin)

[**Building plugins** \\
\\
First-plugin tutorial with the smallest working manifest.](https://docs.openclaw.ai/plugins/building-plugins)
...
## [​](https://docs.openclaw.ai/plugins/architecture\#public-capability-model)  Public capability model
...
### [​](https://docs.openclaw.ai/plugins/architecture\#external-compatibility-stance)  External compatibility stance
...
### [​](https://docs.openclaw.ai/plugins/architecture\#plugin-shapes)  Plugin shapes
...
### [​](https://docs.openclaw.ai/plugins/architecture\#legacy-hooks)  Legacy hooks
...
### [​](https://docs.openclaw.ai/plugins/architecture\#compatibility-signals)  Compatibility signals
...
## [​](https://docs.openclaw.ai/plugins/architecture\#architecture-overview)  Architecture overview

OpenClaw’s plugin system has four layers:

1

[Navigate to header](https://docs.openclaw.ai/plugins/architecture#)
...
### [​](https://docs.openclaw.ai/plugins/architecture\#plugin-metadata-snapshot-and-lookup-table)  Plugin metadata snapshot and lookup table
...
### [​](https://docs.openclaw.ai/plugins/architecture\#channel-plugins-and-the-shared-message-tool)  Channel plugins and the shared message tool
...
Core now defers shared poll parsing until after plugin poll dispatch declines the action, so plugin-owned poll handlers can accept channel-specific poll fields without being blocked by the generic poll parser first.See [Plugin architecture internals](https://docs.openclaw.ai/plugins/architecture-internals) for the full startup sequence.

## [​](https://docs.openclaw.ai/plugins/architecture\#capability-ownership-model)  Capability ownership model
...
### [​](https://docs.openclaw.ai/plugins/architecture\#capability-layering)  Capability layering
...
### [​](https://docs.openclaw.ai/plugins/architecture\#multi-capability-company-plugin-example)  Multi-capability company plugin example
...
### [​](https://docs.openclaw.ai/plugins/architecture\#capability-example-video-understanding)  Capability example: video understanding
...
That avoids baking one provider’s video assumptions into core. The plugin owns the vendor surface; core owns the capability contract and fallback behavior.Video generation already uses that same sequence: core owns the typed capability contract and runtime helper, and vendor plugins register `api.registerVideoGenerationProvider(...)` implementations against it.Need a concrete rollout checklist? See [Capability Cookbook](https://docs.openclaw.ai/tools/capability-cookbook).

## [​](https://docs.openclaw.ai/plugins/architecture\#contracts-and-enforcement)  Contracts and enforcement
...
### [​](https://docs.openclaw.ai/plugins/architecture\#what-belongs-in-a-contract)  What belongs in a contract
...
## [​](https://docs.openclaw.ai/plugins/architecture\#execution-model)  Execution model
...
## [​](https://docs.openclaw.ai/plugins/architecture\#export-boundary)  Export boundary
...
## [​](https://docs.openclaw.ai/plugins/architecture\#internals-and-reference)  Internals and reference

For the load pipeline, registry model, provider runtime hooks, Gateway HTTP routes, message tool schemas, channel target resolution, provider catalogs, context engine plugins, and the guide to adding a new capability, see [Plugin architecture internals](https://docs.openclaw.ai/plugins/architecture-internals).

## [​](https://docs.openclaw.ai/plugins/architecture\#related)  Related

- [Building plugins](https://docs.openclaw.ai/plugins/building-plugins)
- [Plugin manifest](https://docs.openclaw.ai/plugins/manifest)
- [Plugin SDK setup](https://docs.openclaw.ai/plugins/sdk-setup)

[Plugin manifest](https://docs.openclaw.ai/plugins/manifest) [Plugin architecture internals](https://docs.openclaw.ai/plugins/architecture-internals)
