...
title: "Plugin reference - OpenClaw"
---

[Skip to main content](https://docs.openclaw.ai/plugins/reference#content-area)
...
- [Plugin reference](https://docs.openclaw.ai/plugins/reference#plugin-reference)
...
# [​](https://docs.openclaw.ai/plugins/reference\#plugin-reference)  Plugin reference
...
[Plugin inventory](https://docs.openclaw.ai/plugins/plugin-inventory) [Plugin bundles](https://docs.openclaw.ai/plugins/bundles)
