...
runtime helpers.The older `resolveMentionGating*` helpers remain on
...
## [​](https://docs.openclaw.ai/plugins/sdk-channel-plugins\#walkthrough)  Walkthrough

1

[Navigate to header](https://docs.openclaw.ai/plugins/sdk-channel-plugins#step-1-package-and-manifest)

2

[Navigate to header](https://docs.openclaw.ai/plugins/sdk-channel-plugins#)
...
see [Plugin Setup and Config](https://docs.openclaw.ai/plugins/sdk-setup#openclaw-channel):
...
the minimum — `id` and `setup` — and add adapters as you need them.Create `src/channel.ts`:
...
if you need full control.Raw outbound adapters may define a `chunker(text, limit, ctx)` function.
...
[Entry Points](https://docs.openclaw.ai/plugins/sdk-entrypoints#definechannelpluginentry) for all
options.
...
See [Setup and Config](https://docs.openclaw.ai/plugins/sdk-setup#setup-entry) for details.Bundled workspace channels that split setup-safe exports into sidecar
...
[Navigate to header](https://docs.openclaw.ai/plugins/sdk-channel-plugins#step-6-test)
...
## [​](https://docs.openclaw.ai/plugins/sdk-channel-plugins\#file-structure)  File structure
...
## [​](https://docs.openclaw.ai/plugins/sdk-channel-plugins\#advanced-topics)  Advanced topics

[**Threading options** \\
\\
Fixed, account-scoped, or custom reply modes](https://docs.openclaw.ai/plugins/sdk-entrypoints#registration-mode)

[**Message tool integration** \\
\\
describeMessageTool and action discovery](https://docs.openclaw.ai/plugins/architecture#channel-plugins-and-the-shared-message-tool)

[**Target resolution** \\
\\
inferTargetChatType, looksLikeId, resolveTarget](https://docs.openclaw.ai/plugins/architecture-internals#channel-target-resolution)

[**Runtime helpers** \\
\\
TTS, STT, media, subagent via api.runtime](https://docs.openclaw.ai/plugins/sdk-runtime)

[**Channel turn kernel** \\
\\
Shared inbound turn lifecycle: ingest, resolve, record, dispatch, finalize](https://docs.openclaw.ai/plugins/sdk-channel-turn)
...
## [​](https://docs.openclaw.ai/plugins/sdk-channel-plugins\#next-steps)  Next steps
...
## [​](https://docs.openclaw.ai/plugins/sdk-channel-plugins\#related)  Related
...
[Plugin hooks](https://docs.openclaw.ai/plugins/hooks) [Provider plugins](https://docs.openclaw.ai/plugins/sdk-provider-plugins)
