...
- [Host hooks for workflow plugins](https://docs.openclaw.ai/plugins/sdk-overview#host-hooks-for-workflow-plugins)
- [Gateway discovery registration](https://docs.openclaw.ai/plugins/sdk-overview#gateway-discovery-registration)
...
## [​](https://docs.openclaw.ai/plugins/sdk-overview\#registration-api)  Registration API

The `register(api)` callback receives an `OpenClawPluginApi` object with these
methods:

### [​](https://docs.openclaw.ai/plugins/sdk-overview\#capability-registration)  Capability registration
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#tools-and-commands)  Tools and commands
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#infrastructure)  Infrastructure
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#host-hooks-for-workflow-plugins)  Host hooks for workflow plugins
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#gateway-discovery-registration)  Gateway discovery registration
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#cli-registration-metadata)  CLI registration metadata
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#cli-backend-registration)  CLI backend registration
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#exclusive-slots)  Exclusive slots
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#memory-embedding-adapters)  Memory embedding adapters
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#events-and-lifecycle)  Events and lifecycle
...
See [Plugin hooks](https://docs.openclaw.ai/plugins/hooks) for examples, common hook names, and guard
semantics.

### [​](https://docs.openclaw.ai/plugins/sdk-overview\#hook-decision-semantics)  Hook decision semantics
...
### [​](https://docs.openclaw.ai/plugins/sdk-overview\#api-object-fields)  API object fields
...
## [​](https://docs.openclaw.ai/plugins/sdk-overview\#internal-module-convention)  Internal module convention
...
and runtime sidecar checks that packaged installs use for plugin-owned code.Provider plugins can expose a narrow plugin-local contract barrel when a
...
## [​](https://docs.openclaw.ai/plugins/sdk-overview\#related)  Related

[**Entry points** \\
\\
`definePluginEntry` and `defineChannelPluginEntry` options.](https://docs.openclaw.ai/plugins/sdk-entrypoints)

[**Runtime helpers** \\
\\
Full `api.runtime` namespace reference.](https://docs.openclaw.ai/plugins/sdk-runtime)

[**Setup and config** \\
\\
Packaging, manifests, and config schemas.](https://docs.openclaw.ai/plugins/sdk-setup)

[**Testing** \\
\\
Test utilities and lint rules.](https://docs.openclaw.ai/plugins/sdk-testing)

[**SDK migration** \\
\\
Migrating from deprecated surfaces.](https://docs.openclaw.ai/plugins/sdk-migration)

[**Plugin internals** \\
\\
Deep architecture and capability model.](https://docs.openclaw.ai/plugins/architecture)

[Migrate to SDK](https://docs.openclaw.ai/plugins/sdk-migration) [Plugin SDK subpaths](https://docs.openclaw.ai/plugins/sdk-subpaths)
