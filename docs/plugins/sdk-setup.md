...
- [openclaw.channel](https://docs.openclaw.ai/plugins/sdk-setup#openclaw-channel)
- [openclaw.install](https://docs.openclaw.ai/plugins/sdk-setup#openclaw-install)
...
- [ClawHub publishing](https://docs.openclaw.ai/plugins/sdk-setup#clawhub-publishing)
- [Setup entry](https://docs.openclaw.ai/plugins/sdk-setup#setup-entry)
- [Narrow setup helper imports](https://docs.openclaw.ai/plugins/sdk-setup#narrow-setup-helper-imports)
- [Channel-owned single-account promotion](https://docs.openclaw.ai/plugins/sdk-setup#channel-owned-single-account-promotion)
...
## [​](https://docs.openclaw.ai/plugins/sdk-setup\#package-metadata)  Package metadata
...
### [​](https://docs.openclaw.ai/plugins/sdk-setup\#openclaw-fields)  `openclaw` fields
...
### [​](https://docs.openclaw.ai/plugins/sdk-setup\#openclaw-channel)  `openclaw.channel`
...
### [​](https://docs.openclaw.ai/plugins/sdk-setup\#openclaw-install)  `openclaw.install`
...
### [​](https://docs.openclaw.ai/plugins/sdk-setup\#deferred-full-load)  Deferred full load
...
## [​](https://docs.openclaw.ai/plugins/sdk-setup\#plugin-manifest)  Plugin manifest
...
## [​](https://docs.openclaw.ai/plugins/sdk-setup\#clawhub-publishing)  ClawHub publishing
...
## [​](https://docs.openclaw.ai/plugins/sdk-setup\#setup-entry)  Setup entry
...
### [​](https://docs.openclaw.ai/plugins/sdk-setup\#narrow-setup-helper-imports)  Narrow setup helper imports
...
### [​](https://docs.openclaw.ai/plugins/sdk-setup\#channel-owned-single-account-promotion)  Channel-owned single-account promotion
...
## [​](https://docs.openclaw.ai/plugins/sdk-setup\#config-schema)  Config schema
...
### [​](https://docs.openclaw.ai/plugins/sdk-setup\#building-channel-config-schemas)  Building channel config schemas
...
## [​](https://docs.openclaw.ai/plugins/sdk-setup\#setup-wizards)  Setup wizards
...
## [​](https://docs.openclaw.ai/plugins/sdk-setup\#publishing-and-installing)  Publishing and installing

**External plugins:** publish to [ClawHub](https://docs.openclaw.ai/tools/clawhub), then install:

- Auto (ClawHub then npm)
...
## [​](https://docs.openclaw.ai/plugins/sdk-setup\#related)  Related
...
[Agent Harness](https://docs.openclaw.ai/plugins/sdk-agent-harness) [Testing](https://docs.openclaw.ai/plugins/sdk-testing)
