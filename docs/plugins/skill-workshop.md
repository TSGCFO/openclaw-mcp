---
source_url: https://docs.openclaw.ai/plugins/skill-workshop#skill-workshop-plugin
title: "Skill workshop plugin - OpenClaw"
---
...
## [​](https://docs.openclaw.ai/plugins/skill-workshop\#operating-patterns)  Operating patterns
...
## [​](https://docs.openclaw.ai/plugins/skill-workshop\#debugging)  Debugging
...
## [​](https://docs.openclaw.ai/plugins/skill-workshop\#qa-scenarios)  QA scenarios
...
## [​](https://docs.openclaw.ai/plugins/skill-workshop\#when-not-to-enable-auto-apply)  When not to enable auto apply
...
## [​](https://docs.openclaw.ai/plugins/skill-workshop\#related-docs)  Related docs

- [Skills](https://docs.openclaw.ai/tools/skills)
- [Plugins](https://docs.openclaw.ai/tools/plugin)
- [Testing](https://docs.openclaw.ai/reference/test)

[Message presentation](https://docs.openclaw.ai/plugins/message-presentation) [Zalo personal plugin](https://docs.openclaw.ai/plugins/zalouser)
