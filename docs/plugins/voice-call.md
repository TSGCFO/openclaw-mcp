...
- [Session scope](https://docs.openclaw.ai/plugins/voice-call#session-scope)
...
- [Per-number Routing](https://docs.openclaw.ai/plugins/voice-call#per-number-routing)
...
- [Troubleshooting](https://docs.openclaw.ai/plugins/voice-call#troubleshooting)
- [Setup fails webhook exposure](https://docs.openclaw.ai/plugins/voice-call#setup-fails-webhook-exposure)
- [Provider credentials fail](https://docs.openclaw.ai/plugins/voice-call#provider-credentials-fail)
- [Calls start but provider webhooks do not arrive](https://docs.openclaw.ai/plugins/voice-call#calls-start-but-provider-webhooks-do-not-arrive)
- [Signature verification fails](https://docs.openclaw.ai/plugins/voice-call#signature-verification-fails)
- [Google Meet Twilio joins fail](https://docs.openclaw.ai/plugins/voice-call#google-meet-twilio-joins-fail)
- [Realtime call has no speech](https://docs.openclaw.ai/plugins/voice-call#realtime-call-has-no-speech)
...
## [​](https://docs.openclaw.ai/plugins/voice-call\#session-scope)  Session scope
...
### [​](https://docs.openclaw.ai/plugins/voice-call\#streaming-provider-examples)  Streaming provider examples
...
### [​](https://docs.openclaw.ai/plugins/voice-call\#per-number-routing)  Per-number Routing
...
persona, a different response agent, and a different TTS voice.Routes are selected from the provider-supplied dialed `To` number. Keys must be
...
session explicitly when initiating the call.Route overrides currently support:
...
### [​](https://docs.openclaw.ai/plugins/voice-call\#conversation-startup-behavior)  Conversation startup behavior
...
### [​](https://docs.openclaw.ai/plugins/voice-call\#twilio-stream-disconnect-grace)  Twilio stream disconnect grace
...
## [​](https://docs.openclaw.ai/plugins/voice-call\#stale-call-reaper)  Stale call reaper
...
is `0` (disabled).Recommended ranges:
...
## [​](https://docs.openclaw.ai/plugins/voice-call\#webhook-security)  Webhook security
...
[​](https://docs.openclaw.ai/plugins/voice-call#param-webhook-security-allowed-hosts)
...
[​](https://docs.openclaw.ai/plugins/voice-call#param-webhook-security-trust-forwarding-headers)
...
[​](https://docs.openclaw.ai/plugins/voice-call#param-webhook-security-trusted-proxy-ips)
...
standalone CLI runtime.`latency` reads `calls.jsonl` from the default voice-call storage path.
...
## [​](https://docs.openclaw.ai/plugins/voice-call\#troubleshooting)  Troubleshooting

### [​](https://docs.openclaw.ai/plugins/voice-call\#setup-fails-webhook-exposure)  Setup fails webhook exposure
...
`192.168.x`, `169.254.x`, `fc00::/7`, or `fd00::/8` as `publicUrl`.Twilio notify-mode outbound calls send their initial `<Say>` TwiML directly in
...
control.Use one public exposure path:
...
### [​](https://docs.openclaw.ai/plugins/voice-call\#provider-credentials-fail)  Provider credentials fail
...
### [​](https://docs.openclaw.ai/plugins/voice-call\#calls-start-but-provider-webhooks-do-not-arrive)  Calls start but provider webhooks do not arrive
...
### [​](https://docs.openclaw.ai/plugins/voice-call\#signature-verification-fails)  Signature verification fails
...
### [​](https://docs.openclaw.ai/plugins/voice-call\#google-meet-twilio-joins-fail)  Google Meet Twilio joins fail
...
the meeting rejects or ignores an incorrect DTMF sequence.Google Meet passes the Meet DTMF sequence and intro text to `voicecall.start`.
...
after the phone participant has joined the meeting.Use `openclaw logs --follow` for the live phase trace. A healthy Twilio Meet
...
### [​](https://docs.openclaw.ai/plugins/voice-call\#realtime-call-has-no-speech)  Realtime call has no speech

Confirm only one audio mode is enabled. `realtime.enabled` and
`streaming.enabled` cannot both be true.For realtime Twilio calls, also verify:
...
## [​](https://docs.openclaw.ai/plugins/voice-call\#related)  Related
...
[Webhooks plugin](https://docs.openclaw.ai/plugins/webhooks) [Memory wiki](https://docs.openclaw.ai/plugins/memory-wiki)
