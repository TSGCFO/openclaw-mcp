...
- [Auth rules](https://docs.openclaw.ai/providers/ollama#auth-rules)
- [Getting started](https://docs.openclaw.ai/providers/ollama#getting-started)
- [Non-interactive mode](https://docs.openclaw.ai/providers/ollama#non-interactive-mode)
...
- [Vision and image description](https://docs.openclaw.ai/providers/ollama#vision-and-image-description)
- [Configuration](https://docs.openclaw.ai/providers/ollama#configuration)
- [Common recipes](https://docs.openclaw.ai/providers/ollama#common-recipes)
- [Model selection](https://docs.openclaw.ai/providers/ollama#model-selection)
- [Quick verification](https://docs.openclaw.ai/providers/ollama#quick-verification)
- [Ollama Web Search](https://docs.openclaw.ai/providers/ollama#ollama-web-search)
- [Advanced configuration](https://docs.openclaw.ai/providers/ollama#advanced-configuration)
- [Troubleshooting](https://docs.openclaw.ai/providers/ollama#troubleshooting)
- [Related](https://docs.openclaw.ai/providers/ollama#related)
...
## [​](https://docs.openclaw.ai/providers/ollama\#auth-rules)  Auth rules
...
## [​](https://docs.openclaw.ai/providers/ollama\#getting-started)  Getting started
...
### [​](https://docs.openclaw.ai/providers/ollama\#non-interactive-mode)  Non-interactive mode
...
## [​](https://docs.openclaw.ai/providers/ollama\#cloud-models)  Cloud models
...
## [​](https://docs.openclaw.ai/providers/ollama\#vision-and-image-description)  Vision and image description
...
## [​](https://docs.openclaw.ai/providers/ollama\#common-recipes)  Common recipes
...
### [​](https://docs.openclaw.ai/providers/ollama\#quick-verification)  Quick verification
...
## [​](https://docs.openclaw.ai/providers/ollama\#ollama-web-search)  Ollama Web Search
...
## [​](https://docs.openclaw.ai/providers/ollama\#advanced-configuration)  Advanced configuration
...
## [​](https://docs.openclaw.ai/providers/ollama\#related)  Related
