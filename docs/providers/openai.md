...
### [​](https://docs.openclaw.ai/providers/openai\#context-window-cap)  Context window cap
...
## [​](https://docs.openclaw.ai/providers/openai\#gpt-5-prompt-contribution)  GPT-5 prompt contribution
...
## [​](https://docs.openclaw.ai/providers/openai\#voice-and-speech)  Voice and speech
...
## [​](https://docs.openclaw.ai/providers/openai\#azure-openai-endpoints)  Azure OpenAI endpoints
...
### [​](https://docs.openclaw.ai/providers/openai\#configuration)  Configuration
...
### [​](https://docs.openclaw.ai/providers/openai\#api-version)  API version
...
### [​](https://docs.openclaw.ai/providers/openai\#model-names-are-deployment-names)  Model names are deployment names
...
### [​](https://docs.openclaw.ai/providers/openai\#regional-availability)  Regional availability
...
### [​](https://docs.openclaw.ai/providers/openai\#parameter-differences)  Parameter differences
...
## [​](https://docs.openclaw.ai/providers/openai\#advanced-configuration)  Advanced configuration
...
## [​](https://docs.openclaw.ai/providers/openai\#related)  Related
