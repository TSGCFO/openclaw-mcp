...
- [Release publish automation](https://docs.openclaw.ai/reference/RELEASING#release-publish-automation)
...
04. Create `release/YYYY.M.D` from current `main`; do not do normal release work
    directly on `main`.
05. Bump every required version location for the intended tag, run
...
09. For beta, tag `vYYYY.M.D-beta.N`, then run `OpenClaw Release Publish` from
...
newer `main` child run by accident.For release branch or tag validation, run it from the trusted `main` workflow
...
See [Full release validation](https://docs.openclaw.ai/reference/full-release-validation) for the
...
`pnpm ci:full-release --sha <sha>` to create the pinned temporary branch.Use `release_profile` to select live/provider breadth:
...
matrix remains the place for model-specific coverage.Use these variants depending on release stage:
...
### [​](https://docs.openclaw.ai/reference/RELEASING\#vitest)  Vitest
...
### [​](https://docs.openclaw.ai/reference/RELEASING\#docker)  Docker
...
### [​](https://docs.openclaw.ai/reference/RELEASING\#qa-lab)  QA Lab
...
### [​](https://docs.openclaw.ai/reference/RELEASING\#package)  Package
...
## [​](https://docs.openclaw.ai/reference/RELEASING\#release-publish-automation)  Release publish automation
...
## [​](https://docs.openclaw.ai/reference/RELEASING\#npm-workflow-inputs)  NPM workflow inputs
...
## [​](https://docs.openclaw.ai/reference/RELEASING\#stable-npm-release-sequence)  Stable npm release sequence
...
## [​](https://docs.openclaw.ai/reference/RELEASING\#public-references)  Public references
...
## [​](https://docs.openclaw.ai/reference/RELEASING\#related)  Related
