...
title: "Full release validation - OpenClaw"
---

[Skip to main content](https://docs.openclaw.ai/reference/full-release-validation#content-area)
...
- [Top-level stages](https://docs.openclaw.ai/reference/full-release-validation#top-level-stages)
- [Release checks stages](https://docs.openclaw.ai/reference/full-release-validation#release-checks-stages)
- [Docker release-path chunks](https://docs.openclaw.ai/reference/full-release-validation#docker-release-path-chunks)
- [Release profiles](https://docs.openclaw.ai/reference/full-release-validation#release-profiles)
- [Full-only additions](https://docs.openclaw.ai/reference/full-release-validation#full-only-additions)
- [Focused reruns](https://docs.openclaw.ai/reference/full-release-validation#focused-reruns)
- [Evidence to keep](https://docs.openclaw.ai/reference/full-release-validation#evidence-to-keep)
- [Workflow files](https://docs.openclaw.ai/reference/full-release-validation#workflow-files)
...
## [​](https://docs.openclaw.ai/reference/full-release-validation\#top-level-stages)  Top-level stages
...
## [​](https://docs.openclaw.ai/reference/full-release-validation\#release-checks-stages)  Release checks stages
...
## [​](https://docs.openclaw.ai/reference/full-release-validation\#docker-release-path-chunks)  Docker release-path chunks
...
## [​](https://docs.openclaw.ai/reference/full-release-validation\#release-profiles)  Release profiles
...
## [​](https://docs.openclaw.ai/reference/full-release-validation\#full-only-additions)  Full-only additions
...
## [​](https://docs.openclaw.ai/reference/full-release-validation\#focused-reruns)  Focused reruns
...
## [​](https://docs.openclaw.ai/reference/full-release-validation\#evidence-to-keep)  Evidence to keep
...
## [​](https://docs.openclaw.ai/reference/full-release-validation\#workflow-files)  Workflow files
