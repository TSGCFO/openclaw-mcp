...
title: "OpenClaw App SDK API design - OpenClaw"
---

[Skip to main content](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#content-area)
...
- [Namespace design](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#namespace-design)
- [Event contract](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#event-contract)
- [Result contract](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#result-contract)
- [Approvals and questions](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#approvals-and-questions)
- [ToolSpace model](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#toolspace-model)
- [Artifact model](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#artifact-model)
- [Security model](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#security-model)
- [Managed environment provider](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#managed-environment-provider)
- [Package structure](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#package-structure)
- [Generated client strategy](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#generated-client-strategy)
- [Related docs](https://docs.openclaw.ai/reference/openclaw-sdk-api-design#related-docs)
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#namespace-design)  Namespace design
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#event-contract)  Event contract
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#result-contract)  Result contract
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#approvals-and-questions)  Approvals and questions
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#toolspace-model)  ToolSpace model
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#artifact-model)  Artifact model
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#security-model)  Security model
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#managed-environment-provider)  Managed environment provider
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#package-structure)  Package structure
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#generated-client-strategy)  Generated client strategy
...
## [​](https://docs.openclaw.ai/reference/openclaw-sdk-api-design\#related-docs)  Related docs
