...
### [​](https://docs.openclaw.ai/reference/prompt-caching\#env-toggles-one-off-debugging)  Env toggles (one-off debugging)
...
### [​](https://docs.openclaw.ai/reference/prompt-caching\#what-to-inspect)  What to inspect
...
## [​](https://docs.openclaw.ai/reference/prompt-caching\#quick-troubleshooting)  Quick troubleshooting
...
## [​](https://docs.openclaw.ai/reference/prompt-caching\#related)  Related
