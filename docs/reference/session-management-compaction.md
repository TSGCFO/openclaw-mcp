...
- [Source of truth: the Gateway](https://docs.openclaw.ai/reference/session-management-compaction#source-of-truth-the-gateway)
...
- [Store maintenance and disk controls](https://docs.openclaw.ai/reference/session-management-compaction#store-maintenance-and-disk-controls)
- [Cron sessions and run logs](https://docs.openclaw.ai/reference/session-management-compaction#cron-sessions-and-run-logs)
...
- [Compaction: what it is](https://docs.openclaw.ai/reference/session-management-compaction#compaction-what-it-is)
- [Compaction chunk boundaries and tool pairing](https://docs.openclaw.ai/reference/session-management-compaction#compaction-chunk-boundaries-and-tool-pairing)
...
- [Compaction settings (reserveTokens, keepRecentTokens)](https://docs.openclaw.ai/reference/session-management-compaction#compaction-settings-reservetokens-keeprecenttokens)
- [Pluggable compaction providers](https://docs.openclaw.ai/reference/session-management-compaction#pluggable-compaction-providers)
...
- [Related](https://docs.openclaw.ai/reference/session-management-compaction#related)
...
## [​](https://docs.openclaw.ai/reference/session-management-compaction\#store-maintenance-and-disk-controls)  Store maintenance and disk controls
...
## [​](https://docs.openclaw.ai/reference/session-management-compaction\#cron-sessions-and-run-logs)  Cron sessions and run logs
...
## [​](https://docs.openclaw.ai/reference/session-management-compaction\#compaction-chunk-boundaries-and-tool-pairing)  Compaction chunk boundaries and tool pairing
...
## [​](https://docs.openclaw.ai/reference/session-management-compaction\#pluggable-compaction-providers)  Pluggable compaction providers
...
## [​](https://docs.openclaw.ai/reference/session-management-compaction\#related)  Related
