...
title: "Network proxy - OpenClaw"
---

[Skip to main content](https://docs.openclaw.ai/security/network-proxy#content-area)
...
- [Network Proxy](https://docs.openclaw.ai/security/network-proxy#network-proxy)
- [Why Use a Proxy?](https://docs.openclaw.ai/security/network-proxy#why-use-a-proxy)
- [How OpenClaw Routes Traffic](https://docs.openclaw.ai/security/network-proxy#how-openclaw-routes-traffic)
- [Related Proxy Terms](https://docs.openclaw.ai/security/network-proxy#related-proxy-terms)
- [Configuration](https://docs.openclaw.ai/security/network-proxy#configuration)
- [Proxy Requirements](https://docs.openclaw.ai/security/network-proxy#proxy-requirements)
- [Recommended Blocked Destinations](https://docs.openclaw.ai/security/network-proxy#recommended-blocked-destinations)
- [Validation](https://docs.openclaw.ai/security/network-proxy#validation)
- [Limits](https://docs.openclaw.ai/security/network-proxy#limits)
...
# [​](https://docs.openclaw.ai/security/network-proxy\#network-proxy)  Network Proxy
...
## [​](https://docs.openclaw.ai/security/network-proxy\#why-use-a-proxy)  Why Use a Proxy?
...
## [​](https://docs.openclaw.ai/security/network-proxy\#how-openclaw-routes-traffic)  How OpenClaw Routes Traffic
...
## [​](https://docs.openclaw.ai/security/network-proxy\#related-proxy-terms)  Related Proxy Terms
...
## [​](https://docs.openclaw.ai/security/network-proxy\#configuration)  Configuration
...
## [​](https://docs.openclaw.ai/security/network-proxy\#proxy-requirements)  Proxy Requirements
...
## [​](https://docs.openclaw.ai/security/network-proxy\#recommended-blocked-destinations)  Recommended Blocked Destinations
...
## [​](https://docs.openclaw.ai/security/network-proxy\#validation)  Validation
...
## [​](https://docs.openclaw.ai/security/network-proxy\#limits)  Limits
