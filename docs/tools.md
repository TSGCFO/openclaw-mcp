...
- [Tools, skills, and plugins](https://docs.openclaw.ai/tools#tools-skills-and-plugins)
- [Built-in tools](https://docs.openclaw.ai/tools#built-in-tools)
- [Plugin-provided tools](https://docs.openclaw.ai/tools#plugin-provided-tools)
- [Tool configuration](https://docs.openclaw.ai/tools#tool-configuration)
- [Allow and deny lists](https://docs.openclaw.ai/tools#allow-and-deny-lists)
- [Tool profiles](https://docs.openclaw.ai/tools#tool-profiles)
- [Tool groups](https://docs.openclaw.ai/tools#tool-groups)
- [Provider-specific restrictions](https://docs.openclaw.ai/tools#provider-specific-restrictions)
...
## [​](https://docs.openclaw.ai/tools\#tools-skills-and-plugins)  Tools, skills, and plugins
...
## [​](https://docs.openclaw.ai/tools\#built-in-tools)  Built-in tools
...
### [​](https://docs.openclaw.ai/tools\#plugin-provided-tools)  Plugin-provided tools
...
## [​](https://docs.openclaw.ai/tools\#tool-configuration)  Tool configuration

### [​](https://docs.openclaw.ai/tools\#allow-and-deny-lists)  Allow and deny lists
...
### [​](https://docs.openclaw.ai/tools\#tool-profiles)  Tool profiles
...
### [​](https://docs.openclaw.ai/tools\#tool-groups)  Tool groups
...
### [​](https://docs.openclaw.ai/tools\#provider-specific-restrictions)  Provider-specific restrictions
