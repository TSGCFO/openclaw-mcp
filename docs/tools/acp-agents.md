...
[Skip to main content](https://docs.openclaw.ai/tools/acp-agents#content-area)
...
- [Which page do I want?](https://docs.openclaw.ai/tools/acp-agents#which-page-do-i-want)
- [Does this work out of the box?](https://docs.openclaw.ai/tools/acp-agents#does-this-work-out-of-the-box)
- [Supported harness targets](https://docs.openclaw.ai/tools/acp-agents#supported-harness-targets)
- [Operator runbook](https://docs.openclaw.ai/tools/acp-agents#operator-runbook)
- [ACP versus sub-agents](https://docs.openclaw.ai/tools/acp-agents#acp-versus-sub-agents)
- [How ACP runs Claude Code](https://docs.openclaw.ai/tools/acp-agents#how-acp-runs-claude-code)
- [Bound sessions](https://docs.openclaw.ai/tools/acp-agents#bound-sessions)
- [Mental model](https://docs.openclaw.ai/tools/acp-agents#mental-model)
- [Current-conversation binds](https://docs.openclaw.ai/tools/acp-agents#current-conversation-binds)
- [Persistent channel bindings](https://docs.openclaw.ai/tools/acp-agents#persistent-channel-bindings)
- [Binding model](https://docs.openclaw.ai/tools/acp-agents#binding-model)
- [Runtime defaults per agent](https://docs.openclaw.ai/tools/acp-agents#runtime-defaults-per-agent)
- [Example](https://docs.openclaw.ai/tools/acp-agents#example)
- [Behavior](https://docs.openclaw.ai/tools/acp-agents#behavior)
- [Start ACP sessions](https://docs.openclaw.ai/tools/acp-agents#start-acp-sessions)
- [sessions\_spawn parameters](https://docs.openclaw.ai/tools/acp-agents#sessions_spawn-parameters)
- [Spawn bind and thread modes](https://docs.openclaw.ai/tools/acp-agents#spawn-bind-and-thread-modes)
- [Delivery model](https://docs.openclaw.ai/tools/acp-agents#delivery-model)
- [Sandbox compatibility](https://docs.openclaw.ai/tools/acp-agents#sandbox-compatibility)
- [Session target resolution](https://docs.openclaw.ai/tools/acp-agents#session-target-resolution)
- [ACP controls](https://docs.openclaw.ai/tools/acp-agents#acp-controls)
- [Runtime options mapping](https://docs.openclaw.ai/tools/acp-agents#runtime-options-mapping)
- [acpx harness, plugin setup, and permissions](https://docs.openclaw.ai/tools/acp-agents#acpx-harness-plugin-setup-and-permissions)
- [Troubleshooting](https://docs.openclaw.ai/tools/acp-agents#troubleshooting)
- [Related](https://docs.openclaw.ai/tools/acp-agents#related)
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#which-page-do-i-want)  Which page do I want?
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#does-this-work-out-of-the-box)  Does this work out of the box?
...
[ACP agents — setup](https://docs.openclaw.ai/tools/acp-agents-setup) only when the harness
should call those tools directly.

## [​](https://docs.openclaw.ai/tools/acp-agents\#supported-harness-targets)  Supported harness targets
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#operator-runbook)  Operator runbook

Quick `/acp` flow from chat:

1

[Navigate to header](https://docs.openclaw.ai/tools/acp-agents#)
...
[Codex harness v1 support contract](https://docs.openclaw.ai/plugins/codex-harness#v1-support-contract).
...
plugin is unavailable for the requested operation.For `sessions_spawn`, `runtime: "acp"` is advertised only when ACP
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#acp-versus-sub-agents)  ACP versus sub-agents
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#how-acp-runs-claude-code)  How ACP runs Claude Code
...
background-task tracking, and optional conversation/thread binding.CLI backends are separate text-only local fallback runtimes — see
[CLI Backends](https://docs.openclaw.ai/gateway/cli-backends).For operators, the practical rule is:
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#bound-sessions)  Bound sessions

### [​](https://docs.openclaw.ai/tools/acp-agents\#mental-model)  Mental model
...
### [​](https://docs.openclaw.ai/tools/acp-agents\#current-conversation-binds)  Current-conversation binds
...
session in place; `/acp close` removes the binding.Examples:
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#persistent-channel-bindings)  Persistent channel bindings

For non-ephemeral workflows, configure persistent ACP bindings in
top-level `bindings[]` entries.

### [​](https://docs.openclaw.ai/tools/acp-agents\#binding-model)  Binding model

[​](https://docs.openclaw.ai/tools/acp-agents#param-bindings-type)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-bindings-match)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-bindings-agent-id)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-bindings-acp-mode)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-bindings-acp-label)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-bindings-acp-cwd)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-bindings-acp-backend)
...
### [​](https://docs.openclaw.ai/tools/acp-agents\#runtime-defaults-per-agent)  Runtime defaults per agent
...
### [​](https://docs.openclaw.ai/tools/acp-agents\#example)  Example
...
### [​](https://docs.openclaw.ai/tools/acp-agents\#behavior)  Behavior
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#start-acp-sessions)  Start ACP sessions
...
### [​](https://docs.openclaw.ai/tools/acp-agents\#sessions_spawn-parameters)  `sessions_spawn` parameters

[​](https://docs.openclaw.ai/tools/acp-agents#param-task)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-runtime)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-agent-id)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-thread)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-mode)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-cwd)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-label)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-resume-session-id)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-stream-to)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-run-timeout-seconds)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-model)
...
[​](https://docs.openclaw.ai/tools/acp-agents#param-thinking)
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#spawn-bind-and-thread-modes)  Spawn bind and thread modes
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#delivery-model)  Delivery model
...
channel/thread/topic.What OpenClaw sends to the harness:
...
sessions\_send and A2A delivery
...
`tools.sessions.visibility` settings.OpenClaw skips the A2A follow-up only when the requester is the
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#sandbox-compatibility)  Sandbox compatibility
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#session-target-resolution)  Session target resolution

Most `/acp` actions accept an optional session target (`session-key`,
`session-id`, or `session-label`).**Resolution order:**
...
step 2.If no target resolves, OpenClaw returns a clear error
(`Unable to resolve session target: ...`).

## [​](https://docs.openclaw.ai/tools/acp-agents\#acp-controls)  ACP controls
...
### [​](https://docs.openclaw.ai/tools/acp-agents\#runtime-options-mapping)  Runtime options mapping
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#acpx-harness-plugin-setup-and-permissions)  acpx harness, plugin setup, and permissions
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#troubleshooting)  Troubleshooting
...
## [​](https://docs.openclaw.ai/tools/acp-agents\#related)  Related
...
- [`openclaw acp` (bridge mode)](https://docs.openclaw.ai/cli/acp)
- [Sub-agents](https://docs.openclaw.ai/tools/subagents)

[Sub-agents](https://docs.openclaw.ai/tools/subagents) [ACP agents — setup](https://docs.openclaw.ai/tools/acp-agents-setup)
