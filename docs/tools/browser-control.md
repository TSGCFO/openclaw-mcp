...
title: "Browser control API - OpenClaw"
---

[Skip to main content](https://docs.openclaw.ai/tools/browser-control#content-area)
...
- [Control API (optional)](https://docs.openclaw.ai/tools/browser-control#control-api-optional)
- [/act error contract](https://docs.openclaw.ai/tools/browser-control#%2Fact-error-contract)
- [Playwright requirement](https://docs.openclaw.ai/tools/browser-control#playwright-requirement)
- [Docker Playwright install](https://docs.openclaw.ai/tools/browser-control#docker-playwright-install)
- [How it works (internal)](https://docs.openclaw.ai/tools/browser-control#how-it-works-internal)
- [CLI quick reference](https://docs.openclaw.ai/tools/browser-control#cli-quick-reference)
- [Snapshots and refs](https://docs.openclaw.ai/tools/browser-control#snapshots-and-refs)
- [Wait power-ups](https://docs.openclaw.ai/tools/browser-control#wait-power-ups)
- [Debug workflows](https://docs.openclaw.ai/tools/browser-control#debug-workflows)
- [JSON output](https://docs.openclaw.ai/tools/browser-control#json-output)
- [State and environment knobs](https://docs.openclaw.ai/tools/browser-control#state-and-environment-knobs)
- [Security and privacy](https://docs.openclaw.ai/tools/browser-control#security-and-privacy)
- [Related](https://docs.openclaw.ai/tools/browser-control#related)
...
## [​](https://docs.openclaw.ai/tools/browser-control\#control-api-optional)  Control API (optional)
...
### [​](https://docs.openclaw.ai/tools/browser-control\#/act-error-contract)  `/act` error contract
...
### [​](https://docs.openclaw.ai/tools/browser-control\#playwright-requirement)  Playwright requirement
...
Element screenshots also reject `--full-page`; the route returns `fullPage is not supported for element screenshots`.If you see `Playwright is not available in this gateway build`, the packaged
...
#### [​](https://docs.openclaw.ai/tools/browser-control\#docker-playwright-install)  Docker Playwright install
...
`OPENCLAW_HOME_VOLUME` or a bind mount. See [Docker](https://docs.openclaw.ai/install/docker).

## [​](https://docs.openclaw.ai/tools/browser-control\#how-it-works-internal)  How it works (internal)
...
## [​](https://docs.openclaw.ai/tools/browser-control\#cli-quick-reference)  CLI quick reference
...
`suggestedTargetId` from `tabs` in scripts.Snapshot flags at a glance:
...
- `--efficient` (or `--mode efficient`): compact role snapshot preset. Set `browser.snapshotDefaults.mode: "efficient"` to make this the default (see [Gateway configuration](https://docs.openclaw.ai/gateway/configuration-reference#browser)).
- `--interactive`, `--compact`, `--depth`, `--selector` force a role snapshot with `ref=e12` refs. `--frame "<iframe>"` scopes role snapshots to an iframe.
- `--labels` adds a viewport-only screenshot with overlayed ref labels (prints `MEDIA:<path>`).
- `--urls` appends discovered link destinations to AI snapshots.

## [​](https://docs.openclaw.ai/tools/browser-control\#snapshots-and-refs)  Snapshots and refs
...
- **Role snapshot (role refs like `e12`)**: `openclaw browser snapshot --interactive` (or `--compact`, `--depth`, `--selector`, `--frame`)  - Output: a role-based list/tree with `[ref=e12]` (and optional `[nth=1]`).
  ...
  - Add `--urls` when link text is ambiguous and the agent needs concrete
    navigation targets.
- **ARIA snapshot (ARIA refs like `ax12`)**: `openclaw browser snapshot --format aria`  - Output: the accessibility tree as structured nodes.
...
## [​](https://docs.openclaw.ai/tools/browser-control\#wait-power-ups)  Wait power-ups
...
## [​](https://docs.openclaw.ai/tools/browser-control\#debug-workflows)  Debug workflows
...
## [​](https://docs.openclaw.ai/tools/browser-control\#json-output)  JSON output
...
## [​](https://docs.openclaw.ai/tools/browser-control\#state-and-environment-knobs)  State and environment knobs
...
## [​](https://docs.openclaw.ai/tools/browser-control\#security-and-privacy)  Security and privacy
...
## [​](https://docs.openclaw.ai/tools/browser-control\#related)  Related

- [Browser](https://docs.openclaw.ai/tools/browser) — overview, configuration, profiles, security
- [Browser login](https://docs.openclaw.ai/tools/browser-login) — signing in to sites
...
[Browser (OpenClaw-managed)](https://docs.openclaw.ai/tools/browser) [Browser login](https://docs.openclaw.ai/tools/browser-login)
