...
- [Agent guidance](https://docs.openclaw.ai/tools/browser#agent-guidance)
- [Missing browser command or tool](https://docs.openclaw.ai/tools/browser#missing-browser-command-or-tool)
...
- [Browserless Docker on the same host](https://docs.openclaw.ai/tools/browser#browserless-docker-on-the-same-host)
...
- [Custom Chrome MCP launch](https://docs.openclaw.ai/tools/browser#custom-chrome-mcp-launch)
...
- [CDP startup failure vs navigation SSRF block](https://docs.openclaw.ai/tools/browser#cdp-startup-failure-vs-navigation-ssrf-block)
- [Agent tools + how control works](https://docs.openclaw.ai/tools/browser#agent-tools-%2B-how-control-works)
- [Related](https://docs.openclaw.ai/tools/browser#related)
...
## [​](https://docs.openclaw.ai/tools/browser\#plugin-control)  Plugin control
...
## [​](https://docs.openclaw.ai/tools/browser\#agent-guidance)  Agent guidance
...
## [​](https://docs.openclaw.ai/tools/browser\#missing-browser-command-or-tool)  Missing browser command or tool
...
## [​](https://docs.openclaw.ai/tools/browser\#profiles-openclaw-vs-user)  Profiles: `openclaw` vs `user`
...
from Browserless’ connection docs.Example:
...
### [​](https://docs.openclaw.ai/tools/browser\#browserless-docker-on-the-same-host)  Browserless Docker on the same host
...
attach still fails.Do not leave `attachOnly` unset for a loopback Browserless profile. Without
...
## [​](https://docs.openclaw.ai/tools/browser\#direct-websocket-cdp-providers)  Direct WebSocket CDP providers
...
### [​](https://docs.openclaw.ai/tools/browser\#browserbase)  Browserbase
...
## [​](https://docs.openclaw.ai/tools/browser\#existing-session-via-chrome-devtools-mcp)  Existing session via Chrome DevTools MCP
...
already open in that browser profile.Official background and setup references:
...
different name, color, or browser data directory.Default behavior:
...
### [​](https://docs.openclaw.ai/tools/browser\#custom-chrome-mcp-launch)  Custom Chrome MCP launch
...
[Browser control API](https://docs.openclaw.ai/tools/browser-control) for the full reference.

## [​](https://docs.openclaw.ai/tools/browser\#troubleshooting)  Troubleshooting

For Linux-specific issues (especially snap Chromium), see
[Browser troubleshooting](https://docs.openclaw.ai/tools/browser-linux-troubleshooting).For WSL2 Gateway + Windows Chrome split-host setups, see
...
### [​](https://docs.openclaw.ai/tools/browser\#cdp-startup-failure-vs-navigation-ssrf-block)  CDP startup failure vs navigation SSRF block
...
## [​](https://docs.openclaw.ai/tools/browser\#related)  Related

- [Tools Overview](https://docs.openclaw.ai/tools) — all available agent tools
- [Sandboxing](https://docs.openclaw.ai/gateway/sandboxing) — browser control in sandboxed environments
- [Security](https://docs.openclaw.ai/gateway/security) — browser control risks and hardening

[Video generation](https://docs.openclaw.ai/tools/video-generation) [Browser control API](https://docs.openclaw.ai/tools/browser-control)
