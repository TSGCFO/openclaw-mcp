...
[​](https://docs.openclaw.ai/tools/exec#param-command)
...
[​](https://docs.openclaw.ai/tools/exec#param-workdir)
...
[​](https://docs.openclaw.ai/tools/exec#param-env)
...
[​](https://docs.openclaw.ai/tools/exec#param-yield-ms)
...
[​](https://docs.openclaw.ai/tools/exec#param-background)
...
[​](https://docs.openclaw.ai/tools/exec#param-timeout)

timeout

number

default:"tools.exec.timeoutSec"
...
[​](https://docs.openclaw.ai/tools/exec#param-pty)
...
[​](https://docs.openclaw.ai/tools/exec#param-host)
...
[​](https://docs.openclaw.ai/tools/exec#param-security)
...
[​](https://docs.openclaw.ai/tools/exec#param-ask)
...
[​](https://docs.openclaw.ai/tools/exec#param-node)
...
[​](https://docs.openclaw.ai/tools/exec#param-elevated)
...
- No-approval host exec is the default for gateway + node. If you want approvals/allowlist behavior, tighten both `tools.exec.*` and the host `~/.openclaw/exec-approvals.json`; see [Exec approvals](https://docs.openclaw.ai/tools/exec-approvals#yolo-mode-no-approval).
...
- `tools.exec.safeBins`: stdin-only safe binaries that can run without explicit allowlist entries. For behavior details, see [Safe bins](https://docs.openclaw.ai/tools/exec-approvals-advanced#safe-bins-stdin-only).
...
top-level segment to match.`autoAllowSkills` is a separate convenience path in exec approvals. It is not the same as
manual path allowlist entries. For strict explicit trust, keep `autoAllowSkills` disabled.Use the two controls for different jobs:
...
is enabled, the command can wake the session when it emits output or fails.Send keys (tmux-style):
...
## [​](https://docs.openclaw.ai/tools/exec\#apply_patch)  apply\_patch
...
## [​](https://docs.openclaw.ai/tools/exec\#related)  Related

- [Exec Approvals](https://docs.openclaw.ai/tools/exec-approvals) — approval gates for shell commands
- [Sandboxing](https://docs.openclaw.ai/gateway/sandboxing) — running commands in sandboxed environments
- [Background Process](https://docs.openclaw.ai/gateway/background-process) — long-running exec and process tool
- [Security](https://docs.openclaw.ai/gateway/security) — tool policy and elevated access

[Exec approvals — advanced](https://docs.openclaw.ai/tools/exec-approvals-advanced) [Image generation](https://docs.openclaw.ai/tools/image-generation)
