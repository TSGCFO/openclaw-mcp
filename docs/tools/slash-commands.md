...
- `/export-trajectory [path]` asks for exec approval, then exports a JSONL [trajectory bundle](https://docs.openclaw.ai/tools/trajectory) for the current session. Use it when you need the prompt, tool, and transcript timeline for one OpenClaw session. In group chats, the approval prompt and export result go to the owner privately. Alias: `/trajectory`.
...
- `/codex status|models|threads|resume|compact|review|diagnostics|account|mcp|skills` inspects and controls the bundled Codex app-server harness. See [Codex harness](https://docs.openclaw.ai/plugins/codex-harness).
- QQBot-only commands:
  - `/bot-ping`
  - `/bot-version`
  - `/bot-help`
...
## [​](https://docs.openclaw.ai/tools/slash-commands\#/tools)  `/tools`
...
## [​](https://docs.openclaw.ai/tools/slash-commands\#plugin-trace-output)  Plugin trace output
...
## [​](https://docs.openclaw.ai/tools/slash-commands\#mcp-updates)  MCP updates
...
## [​](https://docs.openclaw.ai/tools/slash-commands\#plugin-updates)  Plugin updates
...
## [​](https://docs.openclaw.ai/tools/slash-commands\#btw-side-questions)  BTW side questions
...
## [​](https://docs.openclaw.ai/tools/slash-commands\#related)  Related

- [Creating skills](https://docs.openclaw.ai/tools/creating-skills)
- [Skills](https://docs.openclaw.ai/tools/skills)
- [Skills config](https://docs.openclaw.ai/tools/skills-config)

[Skills config](https://docs.openclaw.ai/tools/skills-config) [ClawHub](https://docs.openclaw.ai/tools/clawhub)
