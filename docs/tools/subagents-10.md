...
- [Thread binding controls](https://docs.openclaw.ai/tools/subagents#thread-binding-controls)
- [Spawn behavior](https://docs.openclaw.ai/tools/subagents#spawn-behavior)
- [Context modes](https://docs.openclaw.ai/tools/subagents#context-modes)
- [Tool: sessions\_spawn](https://docs.openclaw.ai/tools/subagents#tool-sessions_spawn)
- [Tool parameters](https://docs.openclaw.ai/tools/subagents#tool-parameters)
...
- [Quick flow](https://docs.openclaw.ai/tools/subagents#quick-flow)
- [Manual controls](https://docs.openclaw.ai/tools/subagents#manual-controls)
- [Config switches](https://docs.openclaw.ai/tools/subagents#config-switches)
- [Allowlist](https://docs.openclaw.ai/tools/subagents#allowlist)
- [Discovery](https://docs.openclaw.ai/tools/subagents#discovery)
- [Auto-archive](https://docs.openclaw.ai/tools/subagents#auto-archive)
...
- [Announce context](https://docs.openclaw.ai/tools/subagents#announce-context)
- [Stats line](https://docs.openclaw.ai/tools/subagents#stats-line)
- [Why prefer sessions\_history](https://docs.openclaw.ai/tools/subagents#why-prefer-sessions_history)
- [Tool policy](https://docs.openclaw.ai/tools/subagents#tool-policy)
- [Override via config](https://docs.openclaw.ai/tools/subagents#override-via-config)
- [Concurrency](https://docs.openclaw.ai/tools/subagents#concurrency)
- [Liveness and recovery](https://docs.openclaw.ai/tools/subagents#liveness-and-recovery)
- [Stopping](https://docs.openclaw.ai/tools/subagents#stopping)
- [Limitations](https://docs.openclaw.ai/tools/subagents#limitations)
- [Related](https://docs.openclaw.ai/tools/subagents#related)
...
[background task](https://docs.openclaw.ai/automation/tasks).Primary goals:
...
### [​](https://docs.openclaw.ai/tools/subagents\#thread-binding-controls)  Thread binding controls

These commands work on channels that support persistent thread bindings.
See [Thread supporting channels](https://docs.openclaw.ai/tools/subagents#thread-supporting-channels) below.
...
### [​](https://docs.openclaw.ai/tools/subagents\#spawn-behavior)  Spawn behavior
...
- For ACP harness sessions (Claude Code, Gemini CLI, OpenCode, or explicit Codex ACP/acpx), use `sessions_spawn` with `runtime: "acp"` when the tool advertises that runtime. See [ACP delivery model](https://docs.openclaw.ai/tools/acp-agents#delivery-model) when debugging completions or agent-to-agent loops. When the `codex` plugin is enabled, Codex chat/thread control should prefer `/codex ...` over ACP unless the user explicitly asks for ACP/acpx.
...
## [​](https://docs.openclaw.ai/tools/subagents\#context-modes)  Context modes
...
## [​](https://docs.openclaw.ai/tools/subagents\#tool-sessions_spawn)  Tool: `sessions_spawn`
...
chat channel.Availability depends on the caller’s effective tool policy. The `coding` and
...
session to confirm the effective tool list.**Defaults:**
...
### [​](https://docs.openclaw.ai/tools/subagents\#tool-parameters)  Tool parameters

[​](https://docs.openclaw.ai/tools/subagents#param-task)
...
[​](https://docs.openclaw.ai/tools/subagents#param-label)
...
[​](https://docs.openclaw.ai/tools/subagents#param-agent-id)
...
[​](https://docs.openclaw.ai/tools/subagents#param-runtime)
...
[​](https://docs.openclaw.ai/tools/subagents#param-resume-session-id)
...
[​](https://docs.openclaw.ai/tools/subagents#param-stream-to)
...
[​](https://docs.openclaw.ai/tools/subagents#param-model)
...
[​](https://docs.openclaw.ai/tools/subagents#param-thinking)
...
[​](https://docs.openclaw.ai/tools/subagents#param-run-timeout-seconds)
...
[​](https://docs.openclaw.ai/tools/subagents#param-thread)
...
[​](https://docs.openclaw.ai/tools/subagents#param-mode)
...
[​](https://docs.openclaw.ai/tools/subagents#param-cleanup)
...
[​](https://docs.openclaw.ai/tools/subagents#param-sandbox)
...
[​](https://docs.openclaw.ai/tools/subagents#param-context)
...
## [​](https://docs.openclaw.ai/tools/subagents\#thread-bound-sessions)  Thread-bound sessions
...
### [​](https://docs.openclaw.ai/tools/subagents\#thread-supporting-channels)  Thread supporting channels
...
### [​](https://docs.openclaw.ai/tools/subagents\#quick-flow)  Quick flow

1

[Navigate to header](https://docs.openclaw.ai/tools/subagents#)
...
### [​](https://docs.openclaw.ai/tools/subagents\#manual-controls)  Manual controls
...
### [​](https://docs.openclaw.ai/tools/subagents\#config-switches)  Config switches

- **Global default:**`session.threadBindings.enabled`, `session.threadBindings.idleHours`, `session.threadBindings.maxAgeHours`.
- **Channel override and spawn auto-bind keys** are adapter-specific. See [Thread supporting channels](https://docs.openclaw.ai/tools/subagents#thread-supporting-channels) above.

See [Configuration reference](https://docs.openclaw.ai/gateway/configuration-reference) and
[Slash commands](https://docs.openclaw.ai/tools/slash-commands) for current adapter details.

### [​](https://docs.openclaw.ai/tools/subagents\#allowlist)  Allowlist

[​](https://docs.openclaw.ai/tools/subagents#param-agents-list-subagents-allow-agents)
...
[​](https://docs.openclaw.ai/tools/subagents#param-agents-defaults-subagents-allow-agents)
...
[​](https://docs.openclaw.ai/tools/subagents#param-agents-defaults-subagents-require-agent-id)
...
### [​](https://docs.openclaw.ai/tools/subagents\#discovery)  Discovery
...
### [​](https://docs.openclaw.ai/tools/subagents\#auto-archive)  Auto-archive
...
## [​](https://docs.openclaw.ai/tools/subagents\#nested-sub-agents)  Nested sub-agents
...
### [​](https://docs.openclaw.ai/tools/subagents\#depth-levels)  Depth levels
...
### [​](https://docs.openclaw.ai/tools/subagents\#announce-chain)  Announce chain
...
### [​](https://docs.openclaw.ai/tools/subagents\#tool-policy-by-depth)  Tool policy by depth
...
### [​](https://docs.openclaw.ai/tools/subagents\#per-agent-spawn-limit)  Per-agent spawn limit
...
### [​](https://docs.openclaw.ai/tools/subagents\#cascade-stop)  Cascade stop
...
origin only identifies the channel.Child completion aggregation is scoped to the current requester run when
...
### [​](https://docs.openclaw.ai/tools/subagents\#announce-context)  Announce context
...
### [​](https://docs.openclaw.ai/tools/subagents\#stats-line)  Stats line
...
### [​](https://docs.openclaw.ai/tools/subagents\#why-prefer-sessions_history)  Why prefer `sessions_history`
...
## [​](https://docs.openclaw.ai/tools/subagents\#tool-policy)  Tool policy
...
layer.With no restrictive `tools.profile`, sub-agents get **all tools except**
...
is not a raw transcript dump.When `maxSpawnDepth >= 2`, depth-1 orchestrator sub-agents additionally
receive `sessions_spawn`, `subagents`, `sessions_list`, and
`sessions_history` so they can manage their children.

### [​](https://docs.openclaw.ai/tools/subagents\#override-via-config)  Override via config
...
## [​](https://docs.openclaw.ai/tools/subagents\#liveness-and-recovery)  Liveness and recovery
...
descendant completion gating, and per-session concurrency checks.After a gateway restart, stale unended restored runs are pruned unless
...
clearing the aborted marker.Automatic restart recovery is bounded per child session. If the same
...
## [​](https://docs.openclaw.ai/tools/subagents\#related)  Related
...
[Agent send](https://docs.openclaw.ai/tools/agent-send) [ACP agents](https://docs.openclaw.ai/tools/acp-agents)
