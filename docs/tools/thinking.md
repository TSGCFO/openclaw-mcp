...
title: "Thinking levels - OpenClaw"
---
...
- [Fast mode (/fast)](https://docs.openclaw.ai/tools/thinking#fast-mode-%2Ffast)
- [Verbose directives (/verbose or /v)](https://docs.openclaw.ai/tools/thinking#verbose-directives-%2Fverbose-or-%2Fv)
- [Plugin trace directives (/trace)](https://docs.openclaw.ai/tools/thinking#plugin-trace-directives-%2Ftrace)
...
- [Provider profiles](https://docs.openclaw.ai/tools/thinking#provider-profiles)
...
## [​](https://docs.openclaw.ai/tools/thinking\#fast-mode-/fast)  Fast mode (/fast)
...
## [​](https://docs.openclaw.ai/tools/thinking\#plugin-trace-directives-/trace)  Plugin trace directives (/trace)
...
## [​](https://docs.openclaw.ai/tools/thinking\#provider-profiles)  Provider profiles
...
[Reactions](https://docs.openclaw.ai/tools/reactions) [Tokenjuice](https://docs.openclaw.ai/tools/tokenjuice)
