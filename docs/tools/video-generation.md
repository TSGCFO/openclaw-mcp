...
title: "Video generation - OpenClaw"
---

[Skip to main content](https://docs.openclaw.ai/tools/video-generation#content-area)
...
- [Quick start](https://docs.openclaw.ai/tools/video-generation#quick-start)
- [How async generation works](https://docs.openclaw.ai/tools/video-generation#how-async-generation-works)
- [Task lifecycle](https://docs.openclaw.ai/tools/video-generation#task-lifecycle)
- [Supported providers](https://docs.openclaw.ai/tools/video-generation#supported-providers)
- [Capability matrix](https://docs.openclaw.ai/tools/video-generation#capability-matrix)
- [Tool parameters](https://docs.openclaw.ai/tools/video-generation#tool-parameters)
- [Required](https://docs.openclaw.ai/tools/video-generation#required)
- [Content inputs](https://docs.openclaw.ai/tools/video-generation#content-inputs)
- [Style controls](https://docs.openclaw.ai/tools/video-generation#style-controls)
- [Advanced](https://docs.openclaw.ai/tools/video-generation#advanced)
- [Fallback and typed options](https://docs.openclaw.ai/tools/video-generation#fallback-and-typed-options)
- [Actions](https://docs.openclaw.ai/tools/video-generation#actions)
- [Model selection](https://docs.openclaw.ai/tools/video-generation#model-selection)
- [Provider notes](https://docs.openclaw.ai/tools/video-generation#provider-notes)
- [Provider capability modes](https://docs.openclaw.ai/tools/video-generation#provider-capability-modes)
- [Live tests](https://docs.openclaw.ai/tools/video-generation#live-tests)
- [Configuration](https://docs.openclaw.ai/tools/video-generation#configuration)
- [Related](https://docs.openclaw.ai/tools/video-generation#related)
...
## [​](https://docs.openclaw.ai/tools/video-generation\#quick-start)  Quick start

1

[Navigate to header](https://docs.openclaw.ai/tools/video-generation#)
...
## [​](https://docs.openclaw.ai/tools/video-generation\#how-async-generation-works)  How async generation works
...
check progress from the CLI.Outside of session-backed agent runs (for example, direct tool invocations),
the tool falls back to inline generation and returns the final media path
in the same turn.Generated video files are saved under OpenClaw-managed media storage when
...
### [​](https://docs.openclaw.ai/tools/video-generation\#task-lifecycle)  Task lifecycle
...
## [​](https://docs.openclaw.ai/tools/video-generation\#supported-providers)  Supported providers
...
individual [provider pages](https://docs.openclaw.ai/tools/video-generation#related) for details.Run `video_generate action=list` to inspect available providers, models, and
runtime modes at runtime.

### [​](https://docs.openclaw.ai/tools/video-generation\#capability-matrix)  Capability matrix
...
## [​](https://docs.openclaw.ai/tools/video-generation\#tool-parameters)  Tool parameters

### [​](https://docs.openclaw.ai/tools/video-generation\#required)  Required

[​](https://docs.openclaw.ai/tools/video-generation#param-prompt)
...
### [​](https://docs.openclaw.ai/tools/video-generation\#content-inputs)  Content inputs

[​](https://docs.openclaw.ai/tools/video-generation#param-image)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-images)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-image-roles)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-video)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-videos)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-video-roles)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-audio-ref)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-audio-refs)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-audio-roles)
...
### [​](https://docs.openclaw.ai/tools/video-generation\#style-controls)  Style controls

[​](https://docs.openclaw.ai/tools/video-generation#param-aspect-ratio)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-resolution)

resolution

string

`480P`, `720P`, `768P`, or `1080P`.

[​](https://docs.openclaw.ai/tools/video-generation#param-duration-seconds)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-size)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-audio)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-watermark)
...
### [​](https://docs.openclaw.ai/tools/video-generation\#advanced)  Advanced

[​](https://docs.openclaw.ai/tools/video-generation#param-action)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-model)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-filename)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-timeout-ms)
...
[​](https://docs.openclaw.ai/tools/video-generation#param-provider-options)
...
#### [​](https://docs.openclaw.ai/tools/video-generation\#fallback-and-typed-options)  Fallback and typed options
...
## [​](https://docs.openclaw.ai/tools/video-generation\#actions)  Actions
...
## [​](https://docs.openclaw.ai/tools/video-generation\#model-selection)  Model selection
...
candidates fail, the error includes details from each attempt.Set `agents.defaults.mediaGenerationAutoProviderFallback: false` to use
...
## [​](https://docs.openclaw.ai/tools/video-generation\#provider-notes)  Provider notes
...
Provider id: `byteplus`.Models: `seedance-1-0-pro-250528` (default),
...
## [​](https://docs.openclaw.ai/tools/video-generation\#provider-capability-modes)  Provider capability modes
...
mode support deterministically.When one model in a provider has wider reference-input support than the
rest, use `maxInputImagesByModel`, `maxInputVideosByModel`, or
`maxInputAudiosByModel` instead of raising the mode-wide limit.

## [​](https://docs.openclaw.ai/tools/video-generation\#live-tests)  Live tests
...
## [​](https://docs.openclaw.ai/tools/video-generation\#configuration)  Configuration
...
## [​](https://docs.openclaw.ai/tools/video-generation\#related)  Related

- [Alibaba Model Studio](https://docs.openclaw.ai/providers/alibaba)
- [Background tasks](https://docs.openclaw.ai/automation/tasks) — task tracking for async video generation
- [BytePlus](https://docs.openclaw.ai/concepts/model-providers#byteplus-international)
- [ComfyUI](https://docs.openclaw.ai/providers/comfy)
- [Configuration reference](https://docs.openclaw.ai/gateway/config-agents#agent-defaults)
...
[Text to speech (TTS)](https://docs.openclaw.ai/tools/tts) [Browser (OpenClaw-managed)](https://docs.openclaw.ai/tools/browser)
