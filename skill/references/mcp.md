...
_1 pages from docs.openclaw.ai — full content preserved._

## Contents

- [https://docs.openclaw.ai/mcp](#httpsdocsopenclawaimcp)

---

## https://docs.openclaw.ai/mcp

_Source: <https://docs.openclaw.ai/mcp>_
  ...
  "capabilities": {
    "tools": {
      "search_open_claw": {
        ...
        "description": "Search across the OpenClaw knowledge base to find relevant information, code examples, API references, and guides. Use this tool when you need to answer questions about OpenClaw, find specific documentation, understand how features work, or locate implementation details. The search returns contextual content with titles and direct links to the documentation pages. If you need the full content of a specific page, use the query_docs_filesystem tool to `head` or `cat` the page path (append `.mdx` to the path returned from search — e.g. `head -200 /api-reference/create-customer.mdx`).",
        "inputSchema": {
          "type": "object",
          "properties": {
            "query": {
